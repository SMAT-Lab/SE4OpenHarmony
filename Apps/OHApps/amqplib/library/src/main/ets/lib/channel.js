...
import assert from './compat/node/assert';
...
import { closeMessage as closeMsg, inspect, methodName } from './format';
...
Channel.prototype.closeWithError = function(id, reason, code, error) {
  var self = this;
...
export {
  Channel, acceptMessage,BaseChannel
}