...
import { Duplex, EventEmitter, PassThrough, buffer } from '@ohos/node-polyfill'
import Heart from './heartbeat';

import { methodName, closeMessage as closeMsg, inspect } from './format'
import { inherits, format as fmt } from './compat/node/util'
import { IllegalOperationError, stackCapture } from './error'
...
// itself.
// [2] Client has initiated a close; only CloseOk or (simultaneously
...
Connection.prototype.toClosed = function(capturedStack, maybeErr) {
...
export { Connection, isFatalError }
