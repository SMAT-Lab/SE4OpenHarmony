...
class OlympusEquipmentMakernoteDescriptor extends TagDescriptor<OlympusEquipmentMakernoteDirectory> {
  ...
  {
    return this.getIndexedDescription(OlympusEquipmentMakernoteDirectory.TAG_FLASH_TYPE, null,
      "None", null, "Simple E-System", "E-System");
  }

  public getFlashModelDescription(): string
  {
    return this.getIndexedDescription(OlympusEquipmentMakernoteDirectory.TAG_FLASH_MODEL, null,
