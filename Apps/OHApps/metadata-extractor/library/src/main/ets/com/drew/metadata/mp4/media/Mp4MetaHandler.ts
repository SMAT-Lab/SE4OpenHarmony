...
import Mp4MetaDirectory from './Mp4MetaDirectory'
...
export default class Mp4MetaHandler extends Mp4MediaHandler<Mp4MetaDirectory> {
  public constructor(metadata: Metadata, context: Mp4Context) {
    super(metadata, context);
  }

  public getDirectory(): Mp4MetaDirectory
  {
