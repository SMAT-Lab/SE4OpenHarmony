...
export class SamsungType2MakernoteDescriptor extends TagDescriptor<SamsungType2MakernoteDirectory> {
  ...
  public getRawDataByteOrderDescription(): string{
    return this.getIndexedDescription(SamsungType2MakernoteDirectory.TagRawDataByteOrder,
      "Little-endian (Intel)", "Big-endian (Motorola)");
  }

  public getWhiteBalanceSetupDescription(): string{
    return this.getIndexedDescription(SamsungType2MakernoteDirectory.TagWhiteBalanceSetup,
      "Auto", "Manual");
  }
  ...
  public getFaceDetectDescription(): string{
    return this.getIndexedDescription(SamsungType2MakernoteDirectory.TagFaceDetect,
      "Off", "On");
  }

  public getFaceRecognitionDescription(): string{
    return this.getIndexedDescription(SamsungType2MakernoteDirectory.TagFaceRecognition,
      "Off", "On");
  }

  public getLensTypeDescription(): string{
    return this.getIndexedDescription(SamsungType2MakernoteDirectory.TagLensType,
  ...
  public getColorSpaceDescription(): string{
    return this.getIndexedDescription(SamsungType2MakernoteDirectory.TagColorSpace,
      "sRGB", "Adobe RGB");
  }

  public getSmartRangeDescription(): string{
    return this.getIndexedDescription(SamsungType2MakernoteDirectory.TagSmartRange,
      "Off", "On");
  }
}