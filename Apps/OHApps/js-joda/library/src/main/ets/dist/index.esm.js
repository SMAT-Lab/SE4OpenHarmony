...
var CldrDateTimeTextProvider = function () {
  ...
  _proto._createStore = function _createStore(field, locale) {
    ...
    if (field === ChronoField.DAY_OF_WEEK) {
      ...
      _styleMap[TextStyle.FULL] = _data;
      _data = {};
      ...
      _styleMap[TextStyle.NARROW] = _data;
      _data = {};
    ...
    if (field === ChronoField.AMPM_OF_DAY) {
      ...
      _styleMap2[TextStyle.FULL] = _data2;
      _data2 = {};
      _data2[0] = dayPeriodsData.narrow.am;
      _data2[1] = dayPeriodsData.narrow.pm;
      _styleMap2[TextStyle.NARROW] = _data2;
      _data2 = {};
    ...
    if (field === ChronoField.ERA) {
      ...
      _styleMap3[TextStyle.FULL] = _data3;
      _data3 = {};
      _data3[0] = erasData.eraNarrow['0'];
      _data3[1] = erasData.eraNarrow['1'];
      _styleMap3[TextStyle.NARROW] = _data3;
      _data3 = {};
...
var CldrZoneTextPrinterParser = function () {
  function CldrZoneTextPrinterParser(textStyle) {
    ...
    requireInstance$2(textStyle, TextStyle, 'textStyle');
    this._textStyle = textStyle;
...
var WEEK_OF_WEEK_BASED_YEAR_RANGE = ValueRange.of(1, 52, 53);
var WEEK_BASED_YEAR_RANGE = ChronoField.YEAR.range();
var _weekDayMap = {
  ...
  _proto.toString = function toString() {
    ...
    if (this._letter === 'Y') {
      if (this._count === 1) {
        ...
        sb.append('WeekBasedYear,').append(this._count).append(',').append(19).append(',').append(this._count < 4 ? SignStyle.NORMAL : SignStyle.EXCEEDS_PAD);
      }
    } else {
...
function _init() {
  ...
  LocaleDateTimeFormatter.RFC_1123_DATE_TIME = new CldrDateTimeFormatterBuilder().parseCaseInsensitive().parseLenient().optionalStart().appendText(ChronoField.DAY_OF_WEEK, dow).appendLiteral(', ').optionalEnd().appendValue(ChronoField.DAY_OF_MONTH, 2).appendLiteral(' ').appendText(ChronoField.MONTH_OF_YEAR, moy).appendLiteral(' ').appendValue(ChronoField.YEAR, 4).appendLiteral(' ').appendValue(ChronoField.HOUR_OF_DAY, 2).appendLiteral(':').appendValue(ChronoField.MINUTE_OF_HOUR, 2).optionalStart().appendLiteral(':').appendValue(ChronoField.SECOND_OF_MINUTE, 2).optionalEnd().appendLiteral(' ').appendZoneId().toFormatter(ResolverStyle.SMART).withChronology(IsoChronology.INSTANCE);
}
