...
var encodeTable = codec.encodeTable, decodeFields = codec.decodeFields, SCRATCH = Buffer.alloc(65536), EMPTY_OBJECT = Object.freeze({});
...
export const decode = function(id, buf) {
  switch (id) {
   case 655370:
...
export var methodInfoConnectionStart  = {
  id: 655370,
  classId: 10,
  methodId: 10,
...
export var methodInfoConnectionStartOk = {
  id: 655371,
  classId: 10,
  methodId: 11,
...
export var methodInfoConnectionSecure= {
  id: 655380,
  classId: 10,
  methodId: 20,
...
export var methodInfoConnectionSecureOk = {
  id: 655381,
  classId: 10,
  methodId: 21,
...
export var methodInfoConnectionTune = {
  id: 655390,
  classId: 10,
  methodId: 30,
  name: "ConnectionTune",
...
export var methodInfoConnectionTuneOk = {
  id: 655391,
  classId: 10,
  methodId: 31,
...
export var methodInfoConnectionOpen = {
  id: 655400,
  classId: 10,
  methodId: 40,
  name: "ConnectionOpen",
...
export var methodInfoConnectionOpenOk = {
  id: 655401,
  classId: 10,
  methodId: 41,
...
export var methodInfoConnectionClose = {
  id: 655410,
  classId: 10,
  methodId: 50,
...
export var methodInfoConnectionCloseOk = {
  id: 655411,
  classId: 10,
  methodId: 51,
...
export var methodInfoConnectionBlocked = {
  id: 655420,
  classId: 10,
  methodId: 60,
...
export var methodInfoConnectionUnblocked = {
  id: 655421,
  classId: 10,
  methodId: 61,
...
export var methodInfoChannelOpen = {
  id: 1310730,
  classId: 20,
  methodId: 10,
  name: "ChannelOpen",
...
export var methodInfoChannelOpenOk = {
  id: 1310731,
  classId: 20,
  methodId: 11,
  name: "ChannelOpenOk",
...
export var methodInfoChannelFlow = {
  id: 1310740,
  classId: 20,
  methodId: 20,
  name: "ChannelFlow",
...
export var methodInfoChannelFlowOk = {
  id: 1310741,
  classId: 20,
  methodId: 21,
  name: "ChannelFlowOk",
...
export var methodInfoChannelClose = {
  id: 1310760,
  classId: 20,
  methodId: 40,
  name: "ChannelClose",
...
export var methodInfoChannelCloseOk = {
  id: 1310761,
  classId: 20,
  methodId: 41,
  name: "ChannelCloseOk",
...
export var methodInfoAccessRequest = {
  id: 1966090,
  classId: 30,
  methodId: 10,
  name: "AccessRequest",
...
export var methodInfoAccessRequestOk = {
  id: 1966091,
  classId: 30,
  methodId: 11,
...
export var methodInfoExchangeDeclare = {
  id: 2621450,
  classId: 40,
  methodId: 10,
...
export var methodInfoExchangeDeclareOk = {
  id: 2621451,
  classId: 40,
  methodId: 11,
...
export var methodInfoExchangeDelete = {
  id: 2621460,
  classId: 40,
  methodId: 20,
  name: "ExchangeDelete",
...
export var methodInfoExchangeDeleteOk = {
  id: 2621461,
  classId: 40,
  methodId: 21,
...
export var methodInfoExchangeBind = {
  id: 2621470,
  classId: 40,
  methodId: 30,
  name: "ExchangeBind",
...
export var methodInfoExchangeBindOk = {
  id: 2621471,
  classId: 40,
  methodId: 31,
  name: "ExchangeBindOk",
...
export var methodInfoExchangeUnbind = {
  id: 2621480,
  classId: 40,
  methodId: 40,
  name: "ExchangeUnbind",
...
export var methodInfoExchangeUnbindOk = {
  id: 2621491,
  classId: 40,
  methodId: 51,
...
export var methodInfoQueueDeclare = {
  id: 3276810,
  classId: 50,
  methodId: 10,
  name: "QueueDeclare",
...
export var methodInfoQueueDeclareOk = {
  id: 3276811,
  classId: 50,
  methodId: 11,
  name: "QueueDeclareOk",
...
export var methodInfoQueueBind = {
  id: 3276820,
  classId: 50,
  methodId: 20,
  name: "QueueBind",
...
export var methodInfoQueueBindOk = {
  id: 3276821,
  classId: 50,
  methodId: 21,
  name: "QueueBindOk",
...
export var methodInfoQueuePurge = {
  id: 3276830,
  classId: 50,
  methodId: 30,
  name: "QueuePurge",
...
export var methodInfoQueuePurgeOk = {
  id: 3276831,
  classId: 50,
  methodId: 31,
  name: "QueuePurgeOk",
...
export var methodInfoQueueDelete = {
  id: 3276840,
  classId: 50,
  methodId: 40,
  name: "QueueDelete",
...
export var methodInfoQueueDeleteOk = {
  id: 3276841,
  classId: 50,
  methodId: 41,
  name: "QueueDeleteOk",
...
export var methodInfoQueueUnbind = {
  id: 3276850,
  classId: 50,
  methodId: 50,
  name: "QueueUnbind",
...
export var methodInfoQueueUnbindOk = {
  id: 3276851,
  classId: 50,
  methodId: 51,
  name: "QueueUnbindOk",
...
export var methodInfoBasicQosOk = {
  id: 3932171,
  classId: 60,
  methodId: 11,
  name: "BasicQosOk",
...
export var methodInfoBasicConsume = {
  id: 3932180,
  classId: 60,
  methodId: 20,
  name: "BasicConsume",
...
export var methodInfoBasicConsumeOk = {
  id: 3932181,
  classId: 60,
  methodId: 21,
  name: "BasicConsumeOk",
...
export var methodInfoBasicCancel = {
  id: 3932190,
  classId: 60,
  methodId: 30,
  name: "BasicCancel",
...
export var methodInfoBasicCancelOk = {
  id: 3932191,
  classId: 60,
  methodId: 31,
  name: "BasicCancelOk",
...
export var methodInfoBasicPublish = {
  id: 3932200,
  classId: 60,
  methodId: 40,
  name: "BasicPublish",
...
export var methodInfoBasicReturn = {
  id: 3932210,
  classId: 60,
  methodId: 50,
  name: "BasicReturn",
...
export var methodInfoBasicDeliver = {
  id: 3932220,
  classId: 60,
  methodId: 60,
  name: "BasicDeliver",
...
export var methodInfoBasicGetOk = {
  id: 3932231,
  classId: 60,
  methodId: 71,
  name: "BasicGetOk",
...
export var methodInfoBasicGetEmpty = {
  id: 3932232,
  classId: 60,
  methodId: 72,
  name: "BasicGetEmpty",
...
export var methodInfoBasicReject = {
  id: 3932250,
  classId: 60,
  methodId: 90,
  name: "BasicReject",
...
export var methodInfoBasicRecoverAsync = {
  id: 3932260,
  classId: 60,
  methodId: 100,
...
export var methodInfoBasicRecover = {
  id: 3932270,
  classId: 60,
  methodId: 110,
  name: "BasicRecover",
...
export var methodInfoBasicRecoverOk = {
  id: 3932271,
  classId: 60,
  methodId: 111,
  name: "BasicRecoverOk",
...
export var methodInfoBasicNack = {
  id: 3932280,
  classId: 60,
  methodId: 120,
  name: "BasicNack",
...
export var methodInfoTxSelectOk = {
  id: 5898251,
  classId: 90,
  methodId: 11,
  name: "TxSelectOk",
...
export var methodInfoTxCommitOk = {
  id: 5898261,
  classId: 90,
  methodId: 21,
  name: "TxCommitOk",
...
export var methodInfoTxRollback = {
  id: 5898270,
  classId: 90,
  methodId: 30,
  name: "TxRollback",
...
export var methodInfoTxRollbackOk = {
  id: 5898271,
  classId: 90,
  methodId: 31,
  name: "TxRollbackOk",
...
export var methodInfoConfirmSelect = {
  id: 5570570,
  classId: 85,
  methodId: 10,
  name: "ConfirmSelect",
...
export var methodInfoConfirmSelectOk = {
  id: 5570571,
  classId: 85,
  methodId: 11,
...
export var propertiesInfoBasicProperties = {
  id: 60,
