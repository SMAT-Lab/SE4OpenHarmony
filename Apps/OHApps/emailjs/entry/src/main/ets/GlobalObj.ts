...
export default class GlobalObj {
  ...
  getClient(): SMTPClient | null {
    return this._objects?.get(this.CLIENT_STR) ? this._objects?.get(this.CLIENT_STR) as SMTPClient : null
  }

  setClient(objectClass: SMTPClient | null): void {
