(function (factory) {
	...
	*/
	...
	new Vector2( 0.001953125, 0.0 );
	new Vector2( 0.0, 0.001953125 );
	...
	let btn = document.querySelector(".player"); //播放按钮
	let video = document.querySelector(".my_video"); //播放器
	let canvas = document.querySelector(".my_canvas"); // 画布
	...
	const props = {
	  ...
	  initMesh() {
	    this.geometry = new SphereGeometry(100, 32, 16);
	    this.material = new ShaderMaterial({
	      wireframe: false,
	      side: DoubleSide,
	      map: this.videoTexture,
	      uniforms: {
	        tex_0: new Uniform(this.videoTexture),
	      },
...
void main() {
    ...
    gl_FragColor = texColor;
	  ...
	  initCamera() {
	    this.camera = new PerspectiveCamera(45, 1024 / 768, 1, 1000);
