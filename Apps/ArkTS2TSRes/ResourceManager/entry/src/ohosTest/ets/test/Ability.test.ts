...
export default function appTest() {
    describe('ActsResMgrTest', () => {
        ...
        it(BUNDLE + 'CreateFunction_003', 0, async () => {
            ...
            await driver.assertComponentExist(ON.text(await getResourcePluralString(eat_apple, SPECIFIED_NUM) as string));
        ...
        it(BUNDLE + 'CreateFunction_008', 0, async () => {
            ...
            await driver.assertComponentExist(ON.text(await getResourceFormatString(formatStr, world) as string));
