...
class HZSMModel extends SMModel {
    ...
    ////////////////////////////////////////////////////////////////
    constructor() {
        super(new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, HZSMModel.hzsClassTable), HZSMModel.HZS_CLASS_FACTOR, new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, HZSMModel.hzsStateTable), HZSMModel.hzsCharLenTable, Constants.CHARSET_HZ_GB_2312);
    }
    ////////////////////////////////////////////////////////////////
    // constants continued
    ////////////////////////////////////////////////////////////////
    private static hzsClassTable: number[] = [
        PkgInt.pack4bits(1, 0, 0, 0, 0, 0, 0, 0),
        ...
        PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
        PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
        PkgInt.pack4bits(0, 0, 0, 4, 0, 5, 2, 0),
    ...
    private static hzsStateTable: number[] = [
        PkgInt.pack4bits(SMModel.START, SMModel.ERROR, 3, SMModel.START, SMModel.START, SMModel.START, SMModel.ERROR, SMModel.ERROR),
        ...
        PkgInt.pack4bits(SMModel.ITSME, SMModel.ITSME, SMModel.ERROR, SMModel.ERROR, SMModel.START, SMModel.START, 4, SMModel.ERROR),
        PkgInt.pack4bits(5, SMModel.ERROR, 6, SMModel.ERROR, 5, 5, 4, SMModel.ERROR),
        PkgInt.pack4bits(4, SMModel.ERROR, 4, 4, 4, SMModel.ERROR, 4, SMModel.ERROR),
