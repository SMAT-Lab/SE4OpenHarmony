...
class EUCKRSMModel extends SMModel {
    ...
    ////////////////////////////////////////////////////////////////
    public constructor() {
        super(new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, EUCKRSMModel.euckrClassTable), EUCKRSMModel.EUCKR_CLASS_FACTOR, new PkgInt(PkgInt.INDEX_SHIFT_4BITS, PkgInt.SHIFT_MASK_4BITS, PkgInt.BIT_SHIFT_4BITS, PkgInt.UNIT_MASK_4BITS, EUCKRSMModel.euckrStateTable), EUCKRSMModel.euckrCharLenTable, Constants.CHARSET_EUC_KR);
    }
    ////////////////////////////////////////////////////////////////
    // constants continued
    ////////////////////////////////////////////////////////////////
    private static euckrClassTable: number[] = [
        ...
        PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
        PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
        PkgInt.pack4bits(0, 2, 2, 2, 2, 2, 2, 2),
        PkgInt.pack4bits(2, 2, 2, 2, 2, 3, 3, 3),
        PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
        PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
        PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
        PkgInt.pack4bits(2, 3, 2, 2, 2, 2, 2, 2),
        PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
        PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
        PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
        PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
    ...
    private static euckrStateTable: number[] = [
        PkgInt.pack4bits(SMModel.ERROR, SMModel.START, 3, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR, SMModel.ERROR),
