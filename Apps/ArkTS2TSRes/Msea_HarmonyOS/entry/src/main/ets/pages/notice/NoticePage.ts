...
export class NoticePage extends View {
    ...
    updateWithValueParams(params: NoticePage_Params) {
    ...
    render() {
        ...
        Navigation.title(getContext(this).resourceManager.getStringSync($r('app.string.tab_notice')));
...
loadDocument(new NoticePage("1", undefined, {}));
