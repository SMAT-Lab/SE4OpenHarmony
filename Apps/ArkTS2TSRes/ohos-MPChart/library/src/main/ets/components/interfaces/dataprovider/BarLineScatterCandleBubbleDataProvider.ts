...
function generateId(): string {
    return "BarLineScatterCandleBubbleDataProvider_" + ++__generate__Id;
}
/*
...
export default interface BarLineScatterCandleBubbleDataProvider extends ChartInterface {
    getTransformer(axis: AxisDependency): Transformer | null;
    isInverted(axis: AxisDependency): boolean;
    getLowestVisibleX(): number;
    getHighestVisibleX(): number;
    getData(): BarLineScatterCandleBubbleData<IBarLineScatterCandleBubbleDataSet<EntryOhos>> | null;
}
