interface CandleStickChart_Params {
...
function generateId(): string {
    return "CandleStickChart_" + ++__generate__Id;
}
/*
...
export class CandleStickChart extends View {
    ...
    updateWithValueParams(params: CandleStickChart_Params) {
