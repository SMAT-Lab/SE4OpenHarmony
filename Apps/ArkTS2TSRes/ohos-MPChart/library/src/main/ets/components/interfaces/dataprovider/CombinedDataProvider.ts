...
function generateId(): string {
    return "CombinedDataProvider_" + ++__generate__Id;
}
/*
...
export default interface CombinedDataProvider extends LineDataProvider, BarDataProvider, BubbleDataProvider, CandleDataProvider, ScatterDataProvider {
    getCombinedData(): CombinedData | null;
}
