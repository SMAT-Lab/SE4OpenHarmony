interface HorizontalBarChartComponent_Params {
...
function generateId(): string {
    return "HorizontalBarChart_" + ++__generate__Id;
}
/*
...
export default class HorizontalBarChartComponent extends View {
    ...
    updateWithValueParams(params: HorizontalBarChartComponent_Params) {
    ...
    aboutToAppear() {
        console.info('-----------aboutToAppear: enter');
    }
    render() {
        Column.create();
        ...
        Canvas.onAreaChange((oldArea: Area, newArea: Area) => {
            console.info('-----------oldArea: ' + oldArea.width + '   ' + oldArea.height);
            console.info('-----------newArea: ' + newArea.width + '   ' + newArea.height);
            if (this.model) {
