interface CubicAxisPage_Params {
...
function generateId(): string {
    return "CubicAxisPage_" + ++__generate__Id;
}
/*
...
class CubicAxisPage extends View {
    ...
    updateWithValueParams(params: CubicAxisPage_Params) {
...
loadDocument(new CubicAxisPage("1", undefined, {}));
