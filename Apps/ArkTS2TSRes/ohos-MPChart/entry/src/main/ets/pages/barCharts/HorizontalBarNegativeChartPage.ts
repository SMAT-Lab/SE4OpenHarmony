interface HorizontalBarNegativeChartPage_Params {
...
function generateId(): string {
    return "HorizontalBarNegativeChartPage_" + ++__generate__Id;
}
/*
 ...
 */
import { Color as ChartColor, JArrayList, XAxis, XAxisPosition, YAxis, Description, Legend, OnChartValueSelectedListener, Highlight, EntryOhos, YAxisLabelPosition, BarEntry, BarDataSet, BarData, Fill, IBarDataSet, HorizontalBarChart, HorizontalBarChartModel, } from '@ohos/mpchart';
import title, { ChartTitleModel } from '../../title';
import SeekBar, { SeekBarModel } from '../../customcomponents/SeekBar';
import Constants from '../../constants/Constants';
import Utils from '../../utils/Utils';
class HorizontalBarNegativeChartPage extends View {
    ...
    updateWithValueParams(params: HorizontalBarNegativeChartPage_Params) {
...
loadDocument(new HorizontalBarNegativeChartPage("1", undefined, {}));
