interface PiePolylineChartPage_Params {
...
function generateId(): string {
    return "PiePolylineChartPage_" + ++__generate__Id;
}
/*
 ...
 */
import { ChartGesture, ColorTemplate, EntryOhos, Highlight, IPieDataSet, JArrayList, Legend, MPPointF, OnChartGestureListener, OnChartValueSelectedListener, PieChart, PieChartModel, PieData, PieDataSet, PieEntry, ValuePosition, } from '@ohos/mpchart';
import Constants from '../../constants/Constants';
import SeekBar, { SeekBarModel } from '../../customcomponents/SeekBar';
import title, { ChartTitleModel } from '../../title';
import Utils from '../../utils/Utils';
class PiePolylineChartPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.title = 'PiePolylineChartPage';
    ...
    updateWithValueParams(params: PiePolylineChartPage_Params) {
...
loadDocument(new PiePolylineChartPage("1", undefined, {}));
