...
function generateId(): string {
    return "EditTitle_" + ++__generate__Id;
}
/*
...
export class EditTitle extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.back = undefined;
        this.edit = undefined;
        this.__change = new SynchedPropertySimpleTwoWay(params.change, this, "change");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: EditTitle_Params) {
    ...
    private __change: SynchedPropertySimpleTwoWay<boolean>;
    get change() {
    ...
    render() {
        ...
        Image.height(24);
        Row.pop();
        Text.create($r('app.string.edit_notebook'));
        ...
        Button.backgroundColor(this.change ? $r('app.color.theme') : $r('app.color.button_disable'));
        Button.enabled(this.change);
        Button.height(44);
