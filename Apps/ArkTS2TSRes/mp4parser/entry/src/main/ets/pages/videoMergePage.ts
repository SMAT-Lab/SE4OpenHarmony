interface VideoMergePage_Params {
    btnText?: string;
    btnText2?: string;
    imageWidth?: number;
    imageHeight?: number;
...
function generateId(): string {
    return "videoMergePage_" + ++__generate__Id;
}
/*
...
class VideoMergePage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__btnText = new ObservedPropertySimple("视频合成点击执行", this, "btnText");
        this.__btnText2 = new ObservedPropertySimple("视频合成点击执行", this, "btnText2");
    ...
    updateWithValueParams(params: VideoMergePage_Params) {
...
loadDocument(new VideoMergePage("1", undefined, {}));
