interface RecyclerViewDetachDemo_Params {
    color?: Array<string>;
...
function generateId(): string {
    return "RecyclerViewDetachDemo_" + ++__generate__Id;
}
/*
...
class RecyclerViewDetachDemo extends View {
    ...
    updateWithValueParams(params: RecyclerViewDetachDemo_Params) {
...
loadDocument(new RecyclerViewDetachDemo("1", undefined, {}));
