...
export interface dictionaryType1 {
    dictionary: string | Uint8Array | ArrayBufferLike | buffer.Buffer;
}
...
export { onTypeOf1, onTypeOf2, onTypeOf3, onTypeOf4, onTypeOf5, onTypeOf6, onTypeOf7, onTypeOf8, onTypeOf9, onTypeOf10, onTypeOf11, onTypeOf12, onTypeOf13, onTypeOf14, onTypeOf15, onTypeOf16 };
