...
export class Matrix2D2 {
    ...
    setValues(a: number = 1, b: number = 0, c: number = 0, d: number = 1, tx: number = 0, ty: number = 0): Matrix2D2 {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
    ...
    appendTransform(x: number, y: number, scaleX: number, scaleY: number, rotation: number, skewX: number, skewY: number, regX: number = 0, regY: number = 0): Matrix2D2 {
        let cos = 1;
        let sin = 0;
        if (rotation % 360) {
    ...
    prependTransform(x: number, y: number, scaleX: number, scaleY: number, rotation: number, skewX: number, skewY: number, regX: number = 0, regY: number = 0): Matrix2D2 {
        let cos = 1;
        let sin = 0;
        if (rotation % 360) {
            const r = rotation * Matrix2D2.DEG_TO_RAD;
