...
import { A, Box, Circle2, ClipPath, Colour, CSSClipRect, CurrentColor, Defs, Ellipse2, GradientElement, GradientSpread, Group, HasTransform, Image2, Length, Line2, Marker, Mask, PaintReference, Path2, PathDefinition, Pattern, Polygon2, PolyLine, Rect2, SolidColor, Stop, Svg, SVGBase, SvgConditional, SvgConditionalContainer, SvgContainer, SvgElementBase, SvgLinearGradient, SvgObject, SvgPaint, SvgPreserveAspectRatioContainer, SvgRadialGradient, SvgViewBoxContainer, Switch, Symbol, Text2, TextChild, TextContainer, TextPath, TextPositionedContainer, TextRoot, TextSequence, TRef, TSpan, Unit, Use, View } from './SVGBase';
...
import { FillRule, FontKerning, FontStyle, Isolation, LineCap, LineJoin, RenderQuality, Style, TextAnchor, TextDecoration, TextDirection, VectorEffect } from './Style';
