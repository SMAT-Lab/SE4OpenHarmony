interface PolygonPage_Params {
    model?: SVGImageView.SVGImageViewModel;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "PolygonPage_" + ++__generate__Id;
}
/**
...
export class PolygonPage extends View {
    ...
    public getData() {
        ...
        context.resourceManager.getRawFileContent('polygon.svg', (error, value) => {
            if (error != null) {
...
loadDocument(new PolygonPage("1", undefined, {}));
