...
function generateId(): string {
    return "DebugSample_" + ++__generate__Id;
}
/*
...
*/
import { LINEAR_LAYOUT, STICKY_LAYOUT, GRID_LAYOUT, FIX_LAYOUT, JumpBar, layoutDataType } from '@ohos/vlayout';
enum AlignType {
    TOP_LEFT = 0,
    TOP_RIGHT = 1,
    BOTTOM_LEFT = 2,
...
class DebugSample extends View {
    ...
    updateWithValueParams(params: DebugSample_Params) {
...
loadDocument(new DebugSample("1", undefined, {}));
