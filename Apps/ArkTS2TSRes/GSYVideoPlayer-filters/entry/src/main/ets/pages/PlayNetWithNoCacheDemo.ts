interface PlayNetWithNoCacheDemo_Params {
    screenHeight?: string;
...
function generateId(): string {
    return "PlayNetWithNoCacheDemo_" + ++__generate__Id;
}
/*
...
let mDirection = 0;
let screenWidth = 0;
class PlayNetWithNoCacheDemo extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.videoUrl = "http://video.chinanews.com/flv/2019/04/23/400/111773_web.mp4";
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: PlayNetWithNoCacheDemo_Params) {
...
loadDocument(new PlayNetWithNoCacheDemo("1", undefined, {}));
