interface PlayNetWithCacheDemo_Params {
    screenHeight?: string;
...
function generateId(): string {
    return "PlayNetWithCacheDemo_" + ++__generate__Id;
}
/*
...
let mDirection = 0;
let screenWidth = 0;
class PlayNetWithCacheDemo extends View {
    ...
    updateWithValueParams(params: PlayNetWithCacheDemo_Params) {
...
loadDocument(new PlayNetWithCacheDemo("1", undefined, {}));
