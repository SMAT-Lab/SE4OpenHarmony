interface VectorView_Params {
    dataSource?: VectorDataSource;
    totalCount?: number;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "VectorView_" + ++__generate__Id;
}
/*
...
export class VectorView extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__dataSource = new ObservedPropertyObject(new VectorDataSource(), this, "dataSource");
        this.__totalCount = new ObservedPropertySimple(MIN_LENGTH, this, "totalCount");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: VectorView_Params) {
    ...
    private __dataSource: ObservedPropertyObject<VectorDataSource>;
    get dataSource() {
        return this.__dataSource.get();
    }
    set dataSource(newValue: VectorDataSource) {
