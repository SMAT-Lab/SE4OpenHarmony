interface ListView_Params {
    dataSource?: ListDateSource;
    totalCount?: number;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "ListView_" + ++__generate__Id;
}
/*
...
export class ListView extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__dataSource = new ObservedPropertyObject(new ListDateSource(), this, "dataSource");
        this.__totalCount = new ObservedPropertySimple(MIN_LENGTH, this, "totalCount");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: ListView_Params) {
    ...
    private __dataSource: ObservedPropertyObject<ListDateSource>;
    get dataSource() {
        return this.__dataSource.get();
    }
    set dataSource(newValue: ListDateSource) {
...
loadDocument(new ListView("1", undefined, {}));
