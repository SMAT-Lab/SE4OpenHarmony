interface ArrayListView_Params {
    dataSource?: ArrayListDataSource;
    totalCount?: number;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "ArrayListView_" + ++__generate__Id;
}
/*
...
const MIN_LENGTH = 0;
export class ArrayListView extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__dataSource = new ObservedPropertyObject(new ArrayListDataSource(), this, "dataSource");
        this.__totalCount = new ObservedPropertySimple(MIN_LENGTH, this, "totalCount");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: ArrayListView_Params) {
    ...
    private __dataSource: ObservedPropertyObject<ArrayListDataSource>;
    get dataSource() {
        return this.__dataSource.get();
    }
    set dataSource(newValue: ArrayListDataSource) {
        ...
        if (this.totalCount > MIN_LENGTH) {
            ...
            LazyForEach.create("3", this, ObservedObject.GetRawObject(this.dataSource), (item: Information, index: number) => {
                ...
                if (earlierCreatedChild_2 == undefined) {
                    View.create(new InformationItemView("2", this, { index: index, information: item, deleteAction: () => {
                    ...
                    earlierCreatedChild_2.updateWithValueParams({
                        index: index, information: item, deleteAction: () => {
                            this.dataSource.deleteData(index);
                            this.totalCount = this.dataSource.totalCount();
                        }
                    });
