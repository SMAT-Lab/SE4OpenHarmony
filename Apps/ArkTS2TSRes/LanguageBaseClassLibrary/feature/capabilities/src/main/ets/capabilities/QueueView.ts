interface QueueView_Params {
    dataSource?: QueueDataSource;
    totalCount?: number;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "QueueView_" + ++__generate__Id;
}
/*
...
export class QueueView extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__dataSource = new ObservedPropertyObject(new QueueDataSource(), this, "dataSource");
        this.__totalCount = new ObservedPropertySimple(MIN_LENGTH, this, "totalCount");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: QueueView_Params) {
    ...
    private __dataSource: ObservedPropertyObject<QueueDataSource>;
    get dataSource() {
        return this.__dataSource.get();
    }
    set dataSource(newValue: QueueDataSource) {
