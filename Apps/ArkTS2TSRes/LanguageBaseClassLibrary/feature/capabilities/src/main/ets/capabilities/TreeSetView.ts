interface TreeSetView_Params {
    dataSource?: TreeSetDataSource;
    totalCount?: number;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "TreeSetView_" + ++__generate__Id;
}
/*
...
const MIN_LENGTH = 0;
export class TreeSetView extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.dataSource = new TreeSetDataSource();
        this.__totalCount = new ObservedPropertySimple(MIN_LENGTH, this, "totalCount");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: TreeSetView_Params) {
    ...
    private dataSource: TreeSetDataSource;
        ...
        if (this.totalCount > MIN_LENGTH) {
            ...
            LazyForEach.create("3", this, ObservedObject.GetRawObject(this.dataSource), (item: string, index: number) => {
                ...
                if (earlierCreatedChild_2 == undefined) {
                    View.create(new ValueItemView("2", this, { index: index, value: item, deleteAction: () => {
                    ...
                    earlierCreatedChild_2.updateWithValueParams({
                        index: index, value: item, deleteAction: () => {
                            this.dataSource.deleteData(item, index);
                            this.totalCount = this.dataSource.totalCount();
                        }
                    });
