interface ChoicePhotos_Params {
    whichShow?: Array<boolean>;
    ...
    isLand?: boolean;
    listener?;
    maxHeightObj1?: maxHeightType;
    maxHeightObj2?: maxHeightType;
    maxHeightObj3?: maxHeightType;
    maxHeightObj4?: maxHeightType;
    onLand?;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "ChoicePhotos_" + ++__generate__Id;
}
/*
...
export class ChoicePhotos extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.onLand = (mediaQueryResult: mediaQueryResultType) => {
    ...
    updateWithValueParams(params: ChoicePhotos_Params) {
        ...
        if (params.maxHeightObj1 !== undefined) {
            this.maxHeightObj1 = params.maxHeightObj1;
        }
        if (params.maxHeightObj2 !== undefined) {
            this.maxHeightObj2 = params.maxHeightObj2;
        }
        if (params.maxHeightObj3 !== undefined) {
            this.maxHeightObj3 = params.maxHeightObj3;
        }
        if (params.maxHeightObj4 !== undefined) {
            this.maxHeightObj4 = params.maxHeightObj4;
        }
    ...
    private __whichShow: ObservedPropertyObject<Array<boolean>>;
    get whichShow() {
        return this.__whichShow.get();
    }
    set whichShow(newValue: Array<boolean>) {
    ...
    render() {
        ...
        ForEach.create("3", this, ObservedObject.GetRawObject(this.medias), (item: mediaLibrary.FileAsset, index?: number) => {
            ...
            if (typeof index !== "undefined") {
                ...
                if (this.isShowChoices[index]) {
                    If.branchId(0);
                    this.showChoiceBuild('#fffc0303', this.choiceMedias.indexOf(item) + 1, this);
                }
                else {
                    If.branchId(1);
...
loadDocument(new ChoicePhotos("1", undefined, {}));
