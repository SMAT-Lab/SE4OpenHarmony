...
function generateId(): string {
    return "Value.test_" + ++__generate__Id;
}
/*
...
export default function valueTest() {
    describe('ValueTest', () => {
        ...
        it('PassingValueAsArrayBuffer', 0, () => {
            ...
            let certificate = new Uint8Array([0, 1, 2, 3, 4, 5, 6, 7]);
            expect(uint8Buff.toString()).assertEqual(certificate.toString());
        });
    });
}
