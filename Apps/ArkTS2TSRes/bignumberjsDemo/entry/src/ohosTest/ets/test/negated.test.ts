...
function generateId(): string {
    return "negated.test_" + ++__generate__Id;
}
/*
...
export default function negated() {
    describe('negatedtest', () => {
        let t = (expected: string | number, value: BigNumber.Value) => {
            new Test().areEqual(String(expected), new BigNumber(value).negated().toString());
        };
        ...
        it('negated', 0, () => {
            ...
            t(Number.NEGATIVE_INFINITY, Number.POSITIVE_INFINITY);
            t(Number.NEGATIVE_INFINITY, +Number.POSITIVE_INFINITY);
            ...
            t('-Infinity', Number.POSITIVE_INFINITY);
            t('-Infinity', 'Infinity');
            t('Infinity', Number.NEGATIVE_INFINITY);
            t('Infinity', '-Infinity');
            t('NaN', Number.NaN);
            t('NaN', 'NaN');
            BigNumber.config({ EXPONENTIAL_AT: 1e+9 });
            new Test().areEqual(-1, new BigNumber(2).negated().s);
            new Test().areEqual(1, new BigNumber(-2).negated().s);
            new Test().areEqual(null, new BigNumber(Number.NaN).negated().s);
            new Test().areEqual(null, new BigNumber('-NaN').negated().s);
            new Test().areEqual(-1, new BigNumber(Number.POSITIVE_INFINITY).negated().s);
            new Test().areEqual(1, new BigNumber('-Infinity').negated().s);
            new Test().areEqual('-1', new BigNumber(1).negated().valueOf());
            new Test().areEqual('-0', new BigNumber(0).negated().valueOf());
            new Test().areEqual('-0', new BigNumber(0).negated().valueOf());
            new Test().areEqual('-0', new BigNumber('0.00000').negated().valueOf());
            new Test().areEqual('-0', new BigNumber('+0.0').negated().valueOf());
            new Test().areEqual('0', new BigNumber(-0).negated().valueOf());
            new Test().areEqual('0', new BigNumber('-0').negated().valueOf());
        });
    });
