...
export default class CameraService {
    ...
    constructor() {
        ...
        this.receiver = image.createImageReceiver(cameraWH.width, cameraWH.height, FOUR, EIGHT);
    ...
    setVideoFrameWH(videoFrame: VideoFrame): void {
        switch (videoFrame) {
            case VideoFrame.VIDEOFRAME_800_600:
                ...
                Logger.info(TAG, `setVideoFrameWH videoFrameWH:${JSON.stringify(this.videoFrameWH)}`);
                break;
