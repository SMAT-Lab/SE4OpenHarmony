interface SmartRefreshForDropBoxSample_Params {
    modelDropBox?: SmartRefreshForDropBoxSample.Model;
    header?: () => void;
    main?: () => void;
    footer?: () => void;
...
function generateId(): string {
    return "SmartRefreshForDropBoxSample_" + ++__generate__Id;
}
class SmartRefreshForDropBoxSample extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__modelDropBox = new SynchedPropertyObjectTwoWay(params.modelDropBox, this, "modelDropBox");
    ...
    updateWithValueParams(params: SmartRefreshForDropBoxSample_Params) {
    ...
    aboutToBeDeleted() {
        this.__modelDropBox.aboutToBeDeleted();
    ...
    private __modelDropBox: SynchedPropertySimpleOneWay<SmartRefreshForDropBoxSample.Model>;
    get modelDropBox() {
        return this.__modelDropBox.get();
    }
    set modelDropBox(newValue: SmartRefreshForDropBoxSample.Model) {
        this.__modelDropBox.set(newValue);
    }
    private __header?;
    private __main?;
    private __footer?;
    ...
    render() {
        ...
        if (this.header && this.modelDropBox.headerIsRefresh) {
            ...
            if (this.modelDropBox.fixedContent && !this.modelDropBox.flyRefreshHeaderIsShow) {
                ...
                Flex.zIndex(this.modelDropBox.zHeaderIndex);
                Flex.backgroundColor(this.modelDropBox.getBackgroundColor());
                Flex.visibility((this.headerIsVisibleLoadMore && this.modelDropBox.enableRefresh) ? Visibility.Visible : Visibility.None);
                this.header(this);
                Flex.pop();
            }
            If.pop();
        ...
        If.pop();
        Scroll.create(this.modelDropBox.scroller);
        ...
        if (this.footer && this.modelDropBox.footerIsRefresh) {
            ...
            Flex.backgroundColor(this.modelDropBox.getBackgroundShadowColor());
            Flex.visibility((this.footerIsVisibleLoadMore && this.modelDropBox.enableLoadMore) ? Visibility.Visible : Visibility.None);
            this.footer(this);
            Flex.pop();
        }
        If.pop();
