interface SmartRefreshSecond_Params {
...
function generateId(): string {
    return "SmartRefreshSecond_" + ++__generate__Id;
}
class SmartRefreshSecond extends View {
    ...
    updateWithValueParams(params: SmartRefreshSecond_Params) {
