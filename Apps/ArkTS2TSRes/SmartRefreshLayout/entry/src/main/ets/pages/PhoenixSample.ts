interface PhoenixSample_Params {
...
function generateId(): string {
    return "PhoenixSample_" + ++__generate__Id;
}
/*
...
class PhoenixSample extends View {
    ...
    updateWithValueParams(params: PhoenixSample_Params) {
...
loadDocument(new PhoenixSample("1", undefined, {}));
