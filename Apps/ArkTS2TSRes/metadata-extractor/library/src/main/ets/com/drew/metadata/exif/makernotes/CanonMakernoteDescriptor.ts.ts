...
class CanonMakernoteDescriptor extends TagDescriptor<CanonMakernoteDirectory> {
    ...
    public getWhiteBalanceDescription(): string {
        return this.getIndexedDescription(FocalLength.TAG_WHITE_BALANCE, "Auto", "Sunny", "Cloudy", "Tungsten", "Florescent", "Flash", "Custom");
    }
    ...
    public getExposureModeDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_EXPOSURE_MODE, "Easy shooting", "Program", "Tv-priority", "Av-priority", "Manual", "A-DEP");
    }
    ...
    public getAfPointSelectedDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_AF_POINT_SELECTED, 0x3000, "None (MF)", "Auto selected", "Right", "Centre", "Left");
    }
    public getMeteringModeDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_METERING_MODE, 3, "Evaluative", "Partial", "Centre weighted");
    }
    ...
    public getEasyShootingModeDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_EASY_SHOOTING_MODE, "Full auto", "Manual", "Landscape", "Fast shutter", "Slow shutter", "Night", "B&W", "Sepia", "Portrait", "Sports", "Macro / Closeup", "Pan focus");
    }
    public getImageSizeDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_IMAGE_SIZE, "Large", "Medium", "Small");
    }
    public getFocusMode1Description(): string {
        return this.getIndexedDescription(CameraSettings.TAG_FOCUS_MODE_1, "One-shot", "AI Servo", "AI Focus", "Manual Focus", 
    ...
    public getFocusContinuousDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_FOCUS_CONTINUOUS, 0, "Single", "Continuous", null, null, null, null, null, null, "Manual");
    }
    public getAESettingDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_AE_SETTING, 0, "Normal AE", "Exposure Compensation", "AE Lock", "AE Lock + Exposure Comp.", "No AE");
    }
    ...
    public getSpotMeteringModeDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_SPOT_METERING_MODE, 0, "Center", "AF Point");
    }
