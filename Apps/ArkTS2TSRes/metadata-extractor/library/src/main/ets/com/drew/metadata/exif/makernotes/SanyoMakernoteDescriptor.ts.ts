...
export class SanyoMakernoteDescriptor extends TagDescriptor<SanyoMakernoteDirectory> {
    ...
    private getSceneSelectDescription() {
        return this.getIndexedDescription(SanyoMakernoteDirectory.TAG_SCENE_SELECT, "Off", "Sport", "TV", "Night", "User 1", "User 2", "Lamp");
    }
    private getSequenceShotIntervalDescription() {
        return this.getIndexedDescription(SanyoMakernoteDirectory.TAG_SEQUENCE_SHOT_INTERVAL, "5 frames/sec", "10 frames/sec", "15 frames/sec", "20 frames/sec");
    }
    private getFlashModeDescription() {
        return this.getIndexedDescription(SanyoMakernoteDirectory.TAG_FLASH_MODE, "Auto", "Force", "Disabled", "Red eye");
    }
}
