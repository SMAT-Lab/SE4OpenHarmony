...
class NikonType2MakernoteDescriptor extends TagDescriptor<NikonType2MakernoteDirectory> {
    ...
    public getHighISONoiseReductionDescription(): string {
        return this.getIndexedDescription(NikonType2MakernoteDirectory.TAG_HIGH_ISO_NOISE_REDUCTION, "Off", "Minimal", "Low", null, "Normal", null, "High");
    }
    public getFlashUsedDescription(): string {
        return this.getIndexedDescription(NikonType2MakernoteDirectory.TAG_FLASH_USED, "Flash Not Used", "Manual Flash", null, "Flash Not Ready", null, null, null, "External Flash", "Fired, Commander Mode", "Fired, TTL Mode");
    }
    public getNEFCompressionDescription(): string {
        return this.getIndexedDescription(NikonType2MakernoteDirectory.TAG_NEF_COMPRESSION, 1, "Lossy (Type 1)", null, "Uncompressed", null, null, null, "Lossless", "Lossy (Type 2)");
    }
    ...
    public getColorSpaceDescription(): string {
        return this.getIndexedDescription(NikonType2MakernoteDirectory.TAG_COLOR_SPACE, 1, "sRGB", "Adobe RGB");
    }
