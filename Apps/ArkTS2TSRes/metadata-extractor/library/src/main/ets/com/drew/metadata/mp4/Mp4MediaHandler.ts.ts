...
abstract class Mp4MediaHandler<T extends Mp4MediaDirectory> extends Mp4Handler<T> {
    public constructor(metadata: Metadata, context: Mp4Context) {
        ...
        if (context.creationTime != null && context.modificationTime != null) {
            ...
            this.directory.setDate(Mp4MediaDirectory.TAG_CREATION_TIME, DateUtil.get1Jan1904EpochDate(context.creationTime));
            this.directory.setDate(Mp4MediaDirectory.TAG_MODIFICATION_TIME, DateUtil.get1Jan1904EpochDate(context.modificationTime));
