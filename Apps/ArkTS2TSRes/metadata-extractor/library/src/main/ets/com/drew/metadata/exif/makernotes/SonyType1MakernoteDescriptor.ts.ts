...
class SonyType1MakernoteDescriptor extends TagDescriptor<SonyType1MakernoteDirectory> {
    ...
    public getImageQualityDescription(): string {
        return this.getIndexedDescription(SonyType1MakernoteDirectory.TAG_IMAGE_QUALITY, "RAW", "Super Fine", "Fine", "Standard", "Economy", "Extra Fine", "RAW + JPEG", "Compressed RAW", "Compressed RAW + JPEG");
    }
    ...
    public getZoneMatchingDescription(): string {
        return this.getIndexedDescription(SonyType1MakernoteDirectory.TAG_ZONE_MATCHING, "ISO Setting Used", "High Key", "Low Key");
    }
    ...
    public getFocusModeDescription(): string {
        return this.getIndexedDescription(SonyType1MakernoteDirectory.TAG_FOCUS_MODE, "Manual", null, "AF-A", "AF-C", "AF-S", null, "DMF", "AF-D");
    }
    public getAFPointSelectedDescription(): string {
        return this.getIndexedDescription(SonyType1MakernoteDirectory.TAG_AF_POINT_SELECTED, "Auto", // 0
        "Center", // 1
        "Top", // 2
        "Upper-right", // 3
        "Right", // 4
