...
class OlympusMakernoteDescriptor extends TagDescriptor<OlympusMakernoteDirectory> {
    ...
    public getFlashModeCameraSettingDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_FLASH_MODE, null, "Normal", "Red-eye reduction", "Rear flash sync", "Wireless");
    }
    public getWhiteBalanceDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_WHITE_BALANCE, null, "Auto", // 0
        "Daylight", "Cloudy", "Tungsten", null, "Custom", // 5
        null, "Fluorescent", "Fluorescent 2", null, null, // 10
        "Custom 2", "Custom 3");
    }
    ...
    public getShootingModeDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_SHOOTING_MODE, null, "Single", "Continuous", "Self Timer", null, "Bracketing", "Interval", "UHS Continuous", "HS Continuous");
    }
    ...
    public getCameraModelDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_CAMERA_MODEL, null, "DiMAGE 7", "DiMAGE 5", "DiMAGE S304", "DiMAGE S404", "DiMAGE 7i", "DiMAGE 7Hi", "DiMAGE A1", "DiMAGE S414");
    }
    ...
    public getWideFocusZoneDescription(): string {
        return this.getIndexedDescription(CameraSettings.TAG_WIDE_FOCUS_ZONE, null, "No Zone or AF Failed", "Center Zone (Horizontal Orientation)", "Center Zone (Vertical Orientation)", "Left Zone", "Right Zone");
    }
    ...
    public getImageQuality2Description(): string {
        return this.getIndexedDescription(OlympusMakernoteDirectory.TAG_IMAGE_QUALITY_2, null, "Raw", "Super Fine", "Fine", "Standard", "Extra Fine");
    }
    public getImageQuality1Description(): string {
        return this.getIndexedDescription(OlympusMakernoteDirectory.TAG_IMAGE_QUALITY_1, null, "Raw", "Super Fine", "Fine", "Standard", "Extra Fine");
    }
    public getColorModeDescription(): string {
        return this.getIndexedDescription(OlympusMakernoteDirectory.TAG_COLOUR_MODE, null, "Natural Colour", "Black & White", "Vivid Colour", "Solarization", "AdobeRGB");
    }
    ...
    public getJpegQualityDescription(): string {
        ...
        if (cameratype != null) {
            ...
            return this.getIndexedDescription(OlympusMakernoteDirectory.TAG_JPEG_QUALITY, 1, "Standard Quality", "High Quality", "Super High Quality");
    }
