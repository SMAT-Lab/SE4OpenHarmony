...
export class FujifilmMakernoteDescriptor extends TagDescriptor<FujifilmMakernoteDirectory> {
    ...
    public getFlashModeDescription(): string {
        return this.getIndexedDescription(FujifilmMakernoteDirectory.TAG_FLASH_MODE, "Auto", "On", "Off", "Red-eye Reduction", "External");
    }
    ...
    public getAutoBracketingDescription(): string {
        return this.getIndexedDescription(FujifilmMakernoteDirectory.TAG_AUTO_BRACKETING, "Off", "On", "No Flash & Flash");
    }
    ...
    public getBlurWarningDescription(): string {
        return this.getIndexedDescription(FujifilmMakernoteDirectory.TAG_BLUR_WARNING, "No Blur Warning", "Blur warning");
    }
    public getFocusWarningDescription(): string {
        return this.getIndexedDescription(FujifilmMakernoteDirectory.TAG_FOCUS_WARNING, "Good Focus", "Out Of Focus");
    }
    public getAutoExposureWarningDescription(): string {
        return this.getIndexedDescription(FujifilmMakernoteDirectory.TAG_AUTO_EXPOSURE_WARNING, "AE Good", "Over Exposed");
    }
    public getDynamicRangeDescription(): string {
        return this.getIndexedDescription(FujifilmMakernoteDirectory.TAG_DYNAMIC_RANGE, 1, "Standard", null, "Wide");
    }
