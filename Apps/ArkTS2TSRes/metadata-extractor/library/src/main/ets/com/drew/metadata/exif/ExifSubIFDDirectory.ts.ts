...
class ExifSubIFDDirectory extends ExifDirectoryBase {
    ...
    public getDateModified(timeZone?: number): Date {
        ...
        if (parent instanceof ExifIFD0Directory) {
            ...
            return parent.getDate(ExifDirectoryBase.TAG_DATETIME, this.getString(ExifDirectoryBase.TAG_SUBSECOND_TIME), (timeZoneModified != null) ? timeZoneModified : timeZone);
        }
        else {
            return null;
        }
    ...
    public getDateOriginal(timeZone?: number): Date {
        ...
        return this.getDate(ExifDirectoryBase.TAG_DATETIME_ORIGINAL, this.getString(ExifDirectoryBase.TAG_SUBSECOND_TIME_ORIGINAL), (timeZoneOriginal != null) ? timeZoneOriginal : timeZone);
    }
    /**
         * Parses the date/time tag, the subsecond tag and the time offset tag to obtain a single Date
    ...
    public getDateDigitized(timeZone?: number): Date {
        ...
        return this.getDate(ExifDirectoryBase.TAG_DATETIME_DIGITIZED, this.getString(ExifDirectoryBase.TAG_SUBSECOND_TIME_DIGITIZED), (timeZoneDigitized != null) ? timeZoneDigitized : timeZone);
    }
