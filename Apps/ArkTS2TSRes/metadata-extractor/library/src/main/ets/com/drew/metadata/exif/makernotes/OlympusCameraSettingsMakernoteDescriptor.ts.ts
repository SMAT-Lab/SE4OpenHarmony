...
class OlympusCameraSettingsMakernoteDescriptor extends TagDescriptor<OlympusCameraSettingsMakernoteDirectory> {
    ...
    public getPreviewImageValidDescription(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagPreviewImageValid, null, "No", "Yes");
    }
    public getExposureModeDescription(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagExposureMode, 1, "Manual", "Program", "Aperture-priority AE", "Shutter speed priority", "Program-shift");
    }
    public getAeLockDescription(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagAeLock, null, "Off", "On");
    }
        ...
        if (values.length > 1) {
            ...
            if (value1 == 0) {
                ...
                if (((value1 >> 6) & 1) > 0)
                    sb + "Imager AF, ";
                if (((value1 >> 7) & 1) > 0)
                    sb + "Live View Magnification Frame, ";
                if (((value1 >> 8) & 1) > 0)
                    sb + "AF sensor, ";
    ...
    public getModifiedSaturationDescription(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagModifiedSaturation, null, "Off", "CM1 (Red Enhance)", "CM2 (Green Enhance)", "CM3 (Blue Enhance)", "CM4 (Skin Tones)");
    }
    ...
    public getColorSpaceDescription(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagColorSpace, null, "sRGB", "Adobe RGB", "Pro Photo RGB");
    }
    ...
    public getPictureModeBWFilterDescription(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagPictureModeBWFilter, null, "n/a", "Neutral", "Yellow", "Orange", "Red", "Green");
    }
    public getPictureModeToneDescription(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagPictureModeTone, null, "n/a", "Neutral", "Sepia", "Blue", "Purple", "Green");
    }
    ...
    public getImageQuality2Description(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagImageQuality2, 1, "SQ", "HQ", "SHQ", "RAW", "SQ (5)");
    }
    public getImageStabilizationDescription(): string {
        return this.getIndexedDescription(OlympusCameraSettingsMakernoteDirectory.TagImageStabilization, null, "Off", "On, Mode 1", "On, Mode 2", "On, Mode 3", "On, Mode 4");
    }
