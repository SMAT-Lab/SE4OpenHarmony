interface IcoSample_Params {
    isVisibility?: Visibility;
    data?: Array<string>;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "IcoSample_" + ++__generate__Id;
}
/*
...
class IcoSample extends View {
    ...
    updateWithValueParams(params: IcoSample_Params) {
    ...
    render() {
        ...
        Text.pop();
        Text.create("资源路径:/resource/metadata.ico");
        Text.fontSize(22);
        Text.width('100%');
        ...
        Text.pop();
        Column.pop();
        Button.createWithLabel("显示ICO文件的元数据", { type: ButtonType.Normal, stateEffect: true });
...
loadDocument(new IcoSample("1", undefined, {}));
