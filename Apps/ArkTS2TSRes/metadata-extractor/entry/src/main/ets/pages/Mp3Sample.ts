interface Mp3Sample_Params {
    isVisibility?: Visibility;
    data?: Array<string>;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "Mp3Sample_" + ++__generate__Id;
}
/*
...
class Mp3Sample extends View {
    ...
    updateWithValueParams(params: Mp3Sample_Params) {
    ...
    private getMetaData() {
        ...
        let pathMp4 = fileDir.concat("/test.mp3");
        try {
    ...
    render() {
        ...
        Text.pop();
        Text.create("资源路径:/resource/test.mp3");
        Text.fontSize(22);
        Text.width('100%');
        ...
        Text.pop();
        Column.pop();
        Button.createWithLabel("显示mp3文件的元数据", { type: ButtonType.Normal, stateEffect: true });
...
loadDocument(new Mp3Sample("1", undefined, {}));
