interface AviSample_Params {
    isVisibility?: Visibility;
    data?: Array<string>;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "AviSample_" + ++__generate__Id;
}
/*
...
class AviSample extends View {
    ...
    updateWithValueParams(params: AviSample_Params) {
    ...
    private getMetaData() {
        ...
        let pathAvi = fileDir.concat("/AVITest.avi");
        try {
    ...
    render() {
        ...
        Text.pop();
        Text.create("资源路径:/resource/AVITest.avi");
        Text.fontSize(22);
        Text.width('100%');
        ...
        Text.pop();
        Column.pop();
        Button.createWithLabel("显示AVI文件的元数据", { type: ButtonType.Normal, stateEffect: true });
...
loadDocument(new AviSample("1", undefined, {}));
