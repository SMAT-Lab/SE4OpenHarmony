interface WavSample_Params {
    isVisibility?: Visibility;
    data?: Array<string>;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "WavSample_" + ++__generate__Id;
}
/*
...
class WavSample extends View {
    ...
    updateWithValueParams(params: WavSample_Params) {
    ...
    private getMetaData() {
        ...
        let path = fileDir.concat("/test.wav");
        try {
    ...
    render() {
        ...
        Text.pop();
        Text.create("资源路径:/resource/test.wav");
        Text.fontSize(22);
        Text.width('100%');
        ...
        Text.pop();
        Column.pop();
        Button.createWithLabel("显示wav文件的元数据", { type: ButtonType.Normal, stateEffect: true });
...
loadDocument(new WavSample("1", undefined, {}));
