interface Mp4Sample_Params {
    isVisibility?: Visibility;
    data?: Array<string>;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "Mp4Sample_" + ++__generate__Id;
}
/*
...
class Mp4Sample extends View {
    ...
    updateWithValueParams(params: Mp4Sample_Params) {
    ...
    private getMetaData() {
        ...
        let pathMp4 = fileDir.concat("/test.mp4");
        try {
            let metadata: Metadata = ImageMetadataReader.readMetadata(pathMp4);
    ...
    render() {
        ...
        Text.pop();
        Text.create("资源路径:/resource/test.mp4");
        Text.fontSize(22);
        Text.width('100%');
        ...
        Text.pop();
        Column.pop();
        Button.createWithLabel("显示mp4文件的元数据", { type: ButtonType.Normal, stateEffect: true });
...
loadDocument(new Mp4Sample("1", undefined, {}));
