...
function generateId(): string {
    return "BmpSample_" + ++__generate__Id;
}
/*
...
class BmpSample extends View {
    ...
    render() {
        ...
        Text.pop();
        Text.create("资源路径:/resource/Test_01.bmp");
        Text.fontSize(22);
        Text.width('100%');
        ...
        Text.pop();
        Column.pop();
        Button.createWithLabel("显示Bmp文件的元数据", { type: ButtonType.Normal, stateEffect: true });
