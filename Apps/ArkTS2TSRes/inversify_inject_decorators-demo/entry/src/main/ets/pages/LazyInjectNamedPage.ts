interface LazyInjectNamedPage_Params {
    message?: string;
    message2?: string;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "LazyInjectNamedPage_" + ++__generate__Id;
}
/*
 ...
 */
import { LazyInjectNamedFunction } from './lazyInjectInterface';
class LazyInjectNamedPage extends View {
    ...
    updateWithValueParams(params: LazyInjectNamedPage_Params) {
    ...
    sample() {
        let obj = LazyInjectNamedFunction();
        console.log(obj.sword); // true
        console.log(obj.sword); // true
        this.message = obj.sword;
        this.message2 = obj.sword;
    }
}
loadDocument(new LazyInjectNamedPage("1", undefined, {}));
