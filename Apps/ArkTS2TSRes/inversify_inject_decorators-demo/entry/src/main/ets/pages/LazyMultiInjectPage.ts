interface LazyMultiInjectPage_Params {
    message?: string;
    message2?: string;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "LazyMultiInjectPage_" + ++__generate__Id;
}
/*
 ...
 */
import { LazyMultiInjectFunction } from './lazyInjectInterface';
class LazyMultiInjectPage extends View {
    ...
    updateWithValueParams(params: LazyMultiInjectPage_Params) {
    ...
    sample() {
        let obj = LazyMultiInjectFunction();
...
loadDocument(new LazyMultiInjectPage("1", undefined, {}));
