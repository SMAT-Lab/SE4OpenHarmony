...
function generateId(): string {
    return "MqttAsync_" + ++__generate__Id;
}
/*
 ...
 */
var mqttAsync = globalThis.requireNapi("mqttasync", true);
;
var { MqttClientOptions, MqttClient } = globalThis.requireNapi("mqttasync", true);
class MqttAsync {
