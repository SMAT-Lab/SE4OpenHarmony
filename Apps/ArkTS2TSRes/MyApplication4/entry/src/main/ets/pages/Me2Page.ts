interface Me2Page_Params {
    message?: string;
    username?: string;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "Me2Page_" + ++__generate__Id;
}
import { Tabss } from './Tabss';
export class Me2Page extends View {
    ...
    updateWithValueParams(params: Me2Page_Params) {
    ...
    render() {
        ...
        if (earlierCreatedChild_2 == undefined) {
            View.create(new Tabss("2", this, {
                text: "服务",
                img: $r("app.media.simple_service")
        ...
        if (earlierCreatedChild_8 == undefined) {
            View.create(new Tabss("8", this, {
                text: "设置",
                img: $r("app.media.simple_setting")
            }));
        }
        else {
...
loadDocument(new Me2Page("1", undefined, {}));
