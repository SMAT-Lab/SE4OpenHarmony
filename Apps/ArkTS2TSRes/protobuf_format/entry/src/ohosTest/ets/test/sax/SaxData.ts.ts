...
export { attributeNameTestData, attributeNoSpaceData1, attributeNoSpaceData2, attributeNoSpaceData3, attributeNoSpaceData4, attributeNoSpaceData5, attributeUnquotedData, cdataTestData, cdataChunkedTestData, cdataEndSplitTestData, cdataFakeEndTestData1, cdataFakeEndTestData2, cdataMultipleTestData, entitiesTestData, entityMegaTestData, entityNanTestData, issue23TestData, issue30TestData, issue35TestData, issue47TestData, issue49TestData1, issue49TestData2, issue84TestData, issue86TestData1, issue86TestData2, selfClosingChildTestData, selfClosingChildStrictTestData, selfClosingTagTestData, xmlnsAsTagNameTestData, xmlnsIssue41TestData, xmlnsIssue41TestData2, xmlnsRebindingTestData, xmlnsStrictTestData, xmlnsUnboundTestData, xmlnsUnboundElementTestData1, xmlnsUnboundElementTestData2, xmlnsXmlDefaultNsData, xmlnsXmlDefaultPrefixData, xmlnsXmlDefaultPrefixAttributeData, xmlnsXmlDefaultRedefineTestData, bomTestData1, bomTestData2, bomTestData3, bomTestData4, bufferOverrunTestData, caseTestData1, caseTestData2, caseTestData3, cyrillicTestData, duplicateAttributeTestData, emojiTestData, flushTestData, openTagStartTestData1, openTagStartTestData2, scriptTestData, scriptCloseBetterTestData, standAloneCommentTestData, strayEndingTestData, trailingAttributeNoValueTestData, trailingNonWhitespaceTestData, unclosedRootTestData, unquotedTestData, xmlEntitiesTestData };
