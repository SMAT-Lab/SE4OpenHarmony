interface LinkBrotherOneComponent_Params {
...
function generateId(): string {
    return "LinkBrotherOneComponent_" + ++__generate__Id;
}
/*
...
export class LinkBrotherOneComponent extends View {
    ...
    updateWithValueParams(params: LinkBrotherOneComponent_Params) {
    ...
    render() {
        ...
        if (earlierCreatedChild_2 == undefined) {
            // 点击查看源码
            View.create(new ViewCodeText("2", this, { webSrc: { "id": 0, "type": 30000, params: ['LinkBrotherOneComponent.ets.html'] } }));
        }
        else {
            earlierCreatedChild_2.updateWithValueParams({
                webSrc: { "id": 0, "type": 30000, params: ['LinkBrotherOneComponent.ets.html'] }
            });
