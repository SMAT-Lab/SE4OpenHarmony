...
function generateId(): string {
    return "LocalStoragePropPage_" + ++__generate__Id;
}
/*
...
class StoragePropAbilityPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__title = new ObservedPropertyObject($r('app.string.localStorage_pagetitleone'), this, "title");
        this.minFontSize = 10;
    ...
    // 和主页、Page1单向同步内容字体大小
    private __contentFontSize: ObservedPropertyAbstract<number> = this.localStorage_.setAndProp<number>('contentFontSize', 18, this, "contentFontSize");
    get contentFontSize() {
            ...
            View.create(new CodeView("5", this, {
                ...
                contentView: () => {
                    ...
                    if (earlierCreatedChild_4 == undefined) {
                        // 查看源码
                        View.create(new ViewCodeText("4", this, { webSrc: { "id": 0, "type": 30000, params: ['LocalStoragePropPage.ets.html'] } }));
                    }
                    else {
                        earlierCreatedChild_4.updateWithValueParams({
                            webSrc: { "id": 0, "type": 30000, params: ['LocalStoragePropPage.ets.html'] }
                        });
                    ...
                    Button.id('localStoragePropPage');
                    ...
                    Text.pop();
                    Button.pop();
                    Text.create($r('app.string.localStorage_nigntmode_both_binding'));
                    Text.fontSize(this.contentFontSize);
                    Text.fontColor(this.currentModelStatus ? $r('app.color.color_white') : $r('app.color.tips_font_color'));
                    Text.width('100%');
                    Text.textAlign(TextAlign.Center);
                    ...
                    // slider模块控制字体大小
                    Column.pop();
                    Text.create($r('app.string.localStorage_single_fontsize_binding'));
                    Text.fontSize(this.contentFontSize);
                    Text.fontColor(this.currentModelStatus ? $r('app.color.color_white') : $r('app.color.tips_font_color'));
                    Text.width('100%');
                    Text.margin({
...
loadDocument(new StoragePropAbilityPage("1", undefined, {}, storage));
