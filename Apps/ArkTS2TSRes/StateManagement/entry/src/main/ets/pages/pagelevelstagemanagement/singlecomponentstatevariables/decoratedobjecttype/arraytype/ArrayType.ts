interface ArrayType_Params {
    title?: Resource;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "ArrayType_" + ++__generate__Id;
}
/*
...
class ArrayType extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__title = new ObservedPropertyObject($r('app.string.array_type'), this, "title");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: ArrayType_Params) {
    ...
    render() {
        ...
        if (earlierCreatedChild_3 == undefined) {
            View.create(new CodeView("3", this, {
                title: this.__title,
                contentView: () => {
                    let earlierCreatedChild_2: ArrayTypeCode = (this && this.findChildById) ? this.findChildById("2") as ArrayTypeCode : undefined;
                    if (earlierCreatedChild_2 == undefined) {
                        View.create(new ArrayTypeCode("2", this, {}));
                    }
                    else {
...
loadDocument(new ArrayType("1", undefined, {}));
