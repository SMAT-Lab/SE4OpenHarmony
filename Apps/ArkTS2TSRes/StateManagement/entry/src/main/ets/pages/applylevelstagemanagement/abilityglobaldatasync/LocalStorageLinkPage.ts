...
function generateId(): string {
    return "LocalStorageLinkPage_" + ++__generate__Id;
}
/*
...
class StorageLinkAbilityPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__title = new ObservedPropertyObject($r('app.string.localStorage_pagetitletwo'), this, "title");
            ...
            View.create(new CodeView("5", this, {
                ...
                contentView: () => {
                    ...
                    if (earlierCreatedChild_4 == undefined) {
                        // 查看源码
                        View.create(new ViewCodeText("4", this, { webSrc: { "id": 0, "type": 30000, params: ['LocalStorageLinkPage.ets.html'] } }));
                    }
                    else {
                        earlierCreatedChild_4.updateWithValueParams({
                            webSrc: { "id": 0, "type": 30000, params: ['LocalStorageLinkPage.ets.html'] }
                        });
                    ...
                    Button.id('localStorageLinkPage');
...
loadDocument(new StorageLinkAbilityPage("1", undefined, {}, storage));
