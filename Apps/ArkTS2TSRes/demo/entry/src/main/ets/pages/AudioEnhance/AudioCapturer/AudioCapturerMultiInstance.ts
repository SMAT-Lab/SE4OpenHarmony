interface AudioCapturerMultiInstance_Params {
...
function generateId(): string {
    return "AudioCapturerMultiInstance_" + ++__generate__Id;
}
/*
...
class AudioCapturerMultiInstance extends View {
    ...
    updateWithValueParams(params: AudioCapturerMultiInstance_Params) {
    ...
    render() {
        ...
        ForEach.create("2", this, ObservedObject.GetRawObject(this.arr), (item: number) => {
            ...
            Button.height(60);
            Button.backgroundColor(Color.Pink);
            Button.onClick(() => this.getCurrentInputDevices(item));
            ...
            Button.height(60);
            Button.backgroundColor(Color.Pink);
            Button.onClick(() => this.getCurrentAudioCapturerChangeInfo(item));
...
loadDocument(new AudioCapturerMultiInstance("1", undefined, {}));
