...
function generateId(): string {
    return "MicrophoneEnhance_" + ++__generate__Id;
}
/*
...
class Index extends View {
    ...
    render() {
        ...
        Button.height(60);
        Button.onClick(() => {
            router.pushUrl({ url: 'pages/AudioEnhance/Microphone/GetAvailableMicrophones' });
        });
        Text.create("获取可用麦克风配置");
        Text.fontSize(30);
        ...
        Button.height(60);
        Button.onClick(() => {
            router.pushUrl({ url: 'pages/AudioEnhance/Microphone/GetCurrentMicrophones' });
        });
        Text.create("获取当前麦克风配置");
        Text.fontSize(30);
        Text.fontColor(Color.White);
        Text.pop();
        Button.pop();
