interface AdjustSystemVolumeByStep_Params {
...
function generateId(): string {
    return "AdjustSystemVolumeByStep_" + ++__generate__Id;
}
/*
...
class AdjustSystemVolumeByStep extends View {
    ...
    updateWithValueParams(params: AdjustSystemVolumeByStep_Params) {
...
loadDocument(new AdjustSystemVolumeByStep("1", undefined, {}));
