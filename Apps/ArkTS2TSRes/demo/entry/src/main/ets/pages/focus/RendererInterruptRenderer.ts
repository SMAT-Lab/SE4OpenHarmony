interface RendererInterruptRenderer_Params {
...
function generateId(): string {
    return "RendererInterruptRenderer_" + ++__generate__Id;
}
/*
...
class RendererInterruptRenderer extends View {
    ...
    updateWithValueParams(params: RendererInterruptRenderer_Params) {
        ...
        if (params.AudioRendererType !== undefined) {
            this.AudioRendererType = params.AudioRendererType;
        }
...
loadDocument(new RendererInterruptRenderer("1", undefined, {}));
