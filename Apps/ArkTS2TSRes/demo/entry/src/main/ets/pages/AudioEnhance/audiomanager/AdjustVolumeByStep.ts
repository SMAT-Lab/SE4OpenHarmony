interface AdjustVolumeByStep_Params {
...
function generateId(): string {
    return "AdjustVolumeByStep_" + ++__generate__Id;
}
/*
...
class AdjustVolumeByStep extends View {
    ...
    updateWithValueParams(params: AdjustVolumeByStep_Params) {
...
loadDocument(new AdjustVolumeByStep("1", undefined, {}));
