...
class SingleInstancePromise extends View {
    ...
    render() {
        ...
        Column.position({ x: '1%' });
        Text.create("【音频录制-单实例-promise】返回数据：");
        ...
        Text.create("createAudioCapturer promise");
        Text.fontSize(22);
        ...
        Text.create("getBufferSize promise");
        Text.fontSize(22);
        Text.fontColor(Color.White);
        Text.pop();
        Button.pop();
        ...
        Text.create("getCapturerInfo promise");
        Text.fontSize(22);
        Text.fontColor(Color.White);
        Text.pop();
        Button.pop();
        ...
        Text.create("getStreamInfo promise");
        Text.fontSize(22);
        Text.fontColor(Color.White);
        Text.pop();
        Button.pop();
        ...
        Text.create("getAudioStreamId promise");
        Text.fontSize(22);
        Text.fontColor(Color.White);
        Text.pop();
        Button.pop();
        ...
        Text.create("getAudioTime promise");
        Text.fontSize(22);
        Text.fontColor(Color.White);
        Text.pop();
        Button.pop();
