...
class Index extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__message = new ObservedPropertySimple('js-md5', this, "message");
    ...
    render() {
        ...
        Button.pop();
        Button.createWithLabel('md5.hex');
        Button.width(300);
        Button.margin(20);
        Button.fontSize(25);
        Button.onClick(() => {
        ...
        Button.pop();
        Button.createWithLabel('md5.base64');
        Button.width(300);
        Button.margin(20);
        Button.fontSize(25);
        Button.onClick(() => {
