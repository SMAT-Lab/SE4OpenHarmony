interface DiyKeyWordValidatePage_Params {
    message0?: string;
    message1?: string;
    message2?: string;
    message3?: string;
...
function generateId(): string {
    return "DiyKeyWordValidatePage_" + ++__generate__Id;
}
/*
...
class DiyKeyWordValidatePage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__message0 = new ObservedPropertySimple(`validator.attributes.contains = function validateContains(instance, schema, options, ctx) {
...
// result.valid === true;`, this, "message0");
    ...
    updateWithValueParams(params: DiyKeyWordValidatePage_Params) {
...
loadDocument(new DiyKeyWordValidatePage("1", undefined, {}));
