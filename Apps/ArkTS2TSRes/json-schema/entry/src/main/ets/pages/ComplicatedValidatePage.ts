interface ComplicatedValidatePage_Params {
    message0?: string;
    message1?: string;
    message2?: string;
    message3?: string;
...
function generateId(): string {
    return "ComplicatedValidatePage_" + ++__generate__Id;
}
/*
...
class ComplicatedValidatePage extends View {
...
v.validate(p, schema);`, this, "message0");
    ...
    updateWithValueParams(params: ComplicatedValidatePage_Params) {
...
loadDocument(new ComplicatedValidatePage("1", undefined, {}));
