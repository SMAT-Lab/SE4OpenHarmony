interface DefaultBaseUriPage_Params {
    message0?: string;
    message1?: string;
    message2?: string;
    message3?: string;
...
function generateId(): string {
    return "DefaultBaseUriPage_" + ++__generate__Id;
}
/*
...
class DefaultBaseUriPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__message0 = new ObservedPropertySimple(`let result = validate(["Name"], {
  id: "/schema.json",
  type: "array",
  ...
  definitions: {
...
}, { base: 'http://example.com/' });`, this, "message0");
    ...
    updateWithValueParams(params: DefaultBaseUriPage_Params) {
...
loadDocument(new DefaultBaseUriPage("1", undefined, {}));
