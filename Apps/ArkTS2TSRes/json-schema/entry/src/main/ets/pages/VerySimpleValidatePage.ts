interface VerySimpleValidatePage_Params {
    message0?: string;
    message1?: string;
    message2?: string;
    message3?: string;
...
function generateId(): string {
    return "VerySimpleValidatePage_" + ++__generate__Id;
}
/*
...
class VerySimpleValidatePage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__message0 = new ObservedPropertySimple(`let validate = require('jsonschema').validate;
validate(4, {"type": "number"})`, this, "message0");
    ...
    updateWithValueParams(params: VerySimpleValidatePage_Params) {
    ...
    validate() {
        ...
        try {
            ...
            ctx.message3 = `实际结果：${new Validator().validate(4, { "type": "number" }).valid}`;
        }
        catch (err) {
...
loadDocument(new VerySimpleValidatePage("1", undefined, {}));
