...
function generateId(): string {
    return "PageImportHar_" + ++__generate__Id;
}
/**
...
import { add, ohpmRes } from "har";
expect(ohpmRes).assertTrue();
expect(add(2, 3)).assertEqual(5);
class TestPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__message = new ObservedPropertySimple('Import Har Test', this, "message");
