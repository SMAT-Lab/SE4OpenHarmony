...
function generateId(): string {
    return "reflect-getmetadatakeys.test_" + ++__generate__Id;
}
/*
...
export default function getmetadatakeysTest() {
    describe('ActsGetMetadataKeysTest', () => {
        ...
        it('KeysWithoutTargetKeyWhenNotDefined', 0, () => {
            import("reflect-metadata").then((reflectMetadata) => {
                let obj = new type();
                let result: any = Reflect.getMetadataKeys(obj, undefined);
        ...
        it('KeysWithTargetKeyWhenNotDefined', 0, () => {
            import("reflect-metadata").then((reflectMetadata) => {
                let obj = new type();
                let result: any = Reflect.getMetadataKeys(obj, "name");
                expect(result).assertDeepEquals([]);
            });
        });
