interface simpleParseXml_Params {
    message?: string;
    xml?: string;
...
function generateId(): string {
    return "simpleParseXml_" + ++__generate__Id;
}
/*
...
class simpleParseXml extends View {
    ...
    updateWithValueParams(params: simpleParseXml_Params) {
    ...
    private simpleParseXml() {
        xml2js.parseString(this.xml, (err: any, result: any) => {
            this.message = JSON.stringify(result);
        });
    }
}
loadDocument(new simpleParseXml("1", undefined, {}));
