interface EncodeDecodeConstructorPage_Params {
    message?: string;
    message2?: string;
    message3?: string;
...
function generateId(): string {
    return "EncodeDecodeConstructorPage_" + ++__generate__Id;
}
/*
...
class EncodeDecodeConstructorPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__message3 = new ObservedPropertySimple("错误提示", this, "message3");
        this.encodedUint8 = undefined;
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: EncodeDecodeConstructorPage_Params) {
    ...
    render() {
        ...
        Column.create();
        Column.width('100%');
        Button.createWithLabel('点击构造器编码');
        Button.onClick(() => {
        ...
        Text.pop();
        Button.createWithLabel('点击构造器解码');
        Button.onClick(() => {
...
loadDocument(new EncodeDecodeConstructorPage("1", undefined, {}));
