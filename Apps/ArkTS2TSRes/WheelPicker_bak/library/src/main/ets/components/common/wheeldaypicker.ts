interface WheelDayPicker_Params {
    model?: WheelDayPicker.Model;
 ...
 */
const ADAPTWIDTH = "30%";
class WheelDayPicker extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__model = new ObservedPropertyObject(new WheelDayPicker.Model(), this, "model");
        this.scrollerDirection = 0;
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: WheelDayPicker_Params) {
    ...
    private __model: ObservedPropertyObject<WheelDayPicker.Model>;
    get model() {
        return this.__model.get();
    }
    set model(newValue: WheelDayPicker.Model) {
...
namespace WheelDayPicker {
    export class Model {
        ...
        mYear: number = 2022;
        mMonth: number = 1;
        mData: number[] = Array.from(new Array(this.monthDays(this.mYear, this.mMonth)).keys());
        constructor() {
        }
