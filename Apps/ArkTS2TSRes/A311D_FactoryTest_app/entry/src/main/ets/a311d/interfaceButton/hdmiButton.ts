interface hdmiButton_Params {
    backColor?: Color;
    btnName?: string;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "hdmiButton_" + ++__generate__Id;
}
/*
...
export class hdmiButton extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__backColor = new ObservedPropertySimple(Color.Red, this, "backColor");
        this.__btnName = new ObservedPropertySimple("HDMI", this, "btnName");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: hdmiButton_Params) {
