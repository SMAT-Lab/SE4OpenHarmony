...
function generateId(): string {
    return "dsiButton_" + ++__generate__Id;
}
/*
...
export class dsiButton extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__btnName = new ObservedPropertySimple("DSI", this, "btnName");
        this.intervalID = undefined;
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: dsiButton_Params) {
