...
function generateId(): string {
    return "csiButton_" + ++__generate__Id;
}
/*
...
export class csiButton extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__btnName = new ObservedPropertySimple("CSI", this, "btnName");
        this.intervalID = undefined;
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: csiButton_Params) {
