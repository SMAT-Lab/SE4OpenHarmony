...
function generateId(): string {
    return "uartButton_" + ++__generate__Id;
}
/*
...
// import uartTest from '@ohos.uartTest';
import prompt from '@ohos.prompt';
export class uartButton extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__backColor = new ObservedPropertySimple(Color.Red, this, "backColor");
        this.__btnName = new ObservedPropertySimple("40PIN UART", this, "btnName");
        this.intervalID = undefined;
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: uartButton_Params) {
