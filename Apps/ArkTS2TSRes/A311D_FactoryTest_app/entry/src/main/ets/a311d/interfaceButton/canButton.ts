...
function generateId(): string {
    return "canButton_" + ++__generate__Id;
}
/*
...
// @ts-ignore
import cannapi from '@ohos.cannapi';
export class canButton extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__backColor = new ObservedPropertySimple(Color.Red, this, "backColor");
        this.__btnName = new ObservedPropertySimple("CAN BUS", this, "btnName");
        this.intervalID = undefined;
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: canButton_Params) {
    ...
    aboutToAppear() {
        this.intervalID = setInterval(() => {
            cannapi.getsystemparam().then((data) => {
                this.btnName = data.toString();
                if (data == 1) {
