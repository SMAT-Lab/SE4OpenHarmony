...
function generateId(): string {
    return "i2sButton_" + ++__generate__Id;
}
/*
...
export class i2sButton extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__interface = new SynchedPropertySimpleTwoWay(params.interface, this, "interface");
        this.__backColor = new ObservedPropertySimple(Color.Red, this, "backColor");
        this.__btnName = new ObservedPropertySimple("I2S", this, "btnName");
        this.intervalID = undefined;
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: i2sButton_Params) {
    ...
    private __interface: SynchedPropertySimpleTwoWay<number>;
    get interface() {
