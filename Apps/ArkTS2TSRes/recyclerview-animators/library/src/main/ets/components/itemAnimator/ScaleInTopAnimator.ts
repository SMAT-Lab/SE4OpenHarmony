interface ScaleInTopAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "ScaleInTopAnimator_" + ++__generate__Id;
}
/*
...
export class ScaleInTopAnimator extends View {
    ...
    updateWithValueParams(params: ScaleInTopAnimator_Params) {
