interface FadeInRightAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "FadeInRightAnimator_" + ++__generate__Id;
}
/*
...
export class FadeInRightAnimator extends View {
    ...
    updateWithValueParams(params: FadeInRightAnimator_Params) {
