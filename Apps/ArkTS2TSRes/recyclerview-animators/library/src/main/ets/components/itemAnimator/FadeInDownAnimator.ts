interface FadeInDownAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "FadeInDownAnimator_" + ++__generate__Id;
}
/*
...
export class FadeInDownAnimator extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__offsetY = new ObservedPropertySimple(-30, this, "offsetY");
        this.columnsNum = 1;
        this.colNumStr = '';
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: FadeInDownAnimator_Params) {
    ...
    render() {
        ...
        ForEach.create("2", this, ObservedObject.GetRawObject(this.myArr), (item: RecyclerView.ArrayType) => {
            ...
            GridItem.offset({ y: item.isNewValue ? this.offsetY : 0, x: 0 });
