interface FadeInAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "FadeInAnimator_" + ++__generate__Id;
}
/*
...
export class FadeInAnimator extends View {
    ...
    updateWithValueParams(params: FadeInAnimator_Params) {
    ...
    deleteValue(index: number) {
        ...
        this.isClick = false;
        let currentData = this.myArr[index];
