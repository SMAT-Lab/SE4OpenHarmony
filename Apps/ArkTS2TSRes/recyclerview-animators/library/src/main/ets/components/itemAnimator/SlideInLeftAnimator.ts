interface SlideInLeftAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "SlideInLeftAnimator_" + ++__generate__Id;
}
/*
...
export class SlideInLeftAnimator extends View {
    ...
    updateWithValueParams(params: SlideInLeftAnimator_Params) {
