interface OvershootInLeftAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "OvershootInLeftAnimator_" + ++__generate__Id;
}
/*
...
export class OvershootInLeftAnimator extends View {
    ...
    updateWithValueParams(params: OvershootInLeftAnimator_Params) {
