interface ScaleInAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "ScaleInAnimator_" + ++__generate__Id;
}
/*
...
export class ScaleInAnimator extends View {
    ...
    updateWithValueParams(params: ScaleInAnimator_Params) {
    ...
    render() {
        ...
        Grid.width('100%');
        ForEach.create("2", this, ObservedObject.GetRawObject(this.myArr), (item: RecyclerView.ArrayType, index) => {
            GridItem.create();
            Context.animation({
