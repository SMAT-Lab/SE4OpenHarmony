interface ScaleInLeftAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "ScaleInLeftAnimator_" + ++__generate__Id;
}
/*
...
export class ScaleInLeftAnimator extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__landing = new ObservedPropertySimple(1, this, "landing");
        this.columnsNum = 1;
        this.colNumStr = '';
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: ScaleInLeftAnimator_Params) {
    ...
    aboutToBeDeleted() {
        ...
        this.__landing.aboutToBeDeleted();
    ...
    private __landing: ObservedPropertySimple<number>;
    get landing() {
        return this.__landing.get();
    }
    set landing(newValue: number) {
        this.__landing.set(newValue);
    }
    ...
    aboutToAppear() {
        ...
        this.array.forEach(item => {
            let newArr = new RecyclerView.ArrayType(false, item);
    ...
    private addValue(index: number, value: any) {
        ...
        this.isClick = false;
        let newArr = new RecyclerView.ArrayType(true, value);
        this.trans = 1;
        this.duration = 0;
        this.landing = 0;
    ...
    render() {
        ...
        ForEach.create("2", this, ObservedObject.GetRawObject(this.myArr), (item: RecyclerView.ArrayType) => {
            ...
            GridItem.scale(item.isNewValue ?
                {
                    x: this.landing,
                    y: this.landing,
                    z: this.landing,
