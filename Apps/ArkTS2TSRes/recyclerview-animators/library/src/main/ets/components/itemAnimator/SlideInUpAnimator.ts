interface SlideInUpAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "SlideInUpAnimator_" + ++__generate__Id;
}
/*
...
export class SlideInUpAnimator extends View {
    ...
    updateWithValueParams(params: SlideInUpAnimator_Params) {
