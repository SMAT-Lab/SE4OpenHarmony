interface SlideInRightAnimationAdapter_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "SlideInRightAnimationAdapter_" + ++__generate__Id;
}
/*
...
export class SlideInRightAnimationAdapter extends View {
    ...
    updateWithValueParams(params: SlideInRightAnimationAdapter_Params) {
