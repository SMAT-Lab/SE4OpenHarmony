interface LandingAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "LandingAnimator_" + ++__generate__Id;
}
/*
...
export class LandingAnimator extends View {
    ...
    updateWithValueParams(params: LandingAnimator_Params) {
