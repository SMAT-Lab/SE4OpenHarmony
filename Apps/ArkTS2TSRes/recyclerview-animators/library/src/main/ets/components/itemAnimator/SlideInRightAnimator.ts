interface SlideInRightAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "SlideInRightAnimator_" + ++__generate__Id;
}
/*
...
export class SlideInRightAnimator extends View {
    ...
    updateWithValueParams(params: SlideInRightAnimator_Params) {
    ...
    deleteValue(index: number) {
        ...
        this.isClick = false;
        let currentData: any = this.myArr[index];
