interface AlphaInAnimationAdapter_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "AlphaInAnimationAdapter_" + ++__generate__Id;
}
/*
...
export class AlphaInAnimationAdapter extends View {
    ...
    updateWithValueParams(params: AlphaInAnimationAdapter_Params) {
    ...
    render() {
        ...
        ForEach.create("2", this, ObservedObject.GetRawObject(this.list), (item: any, index: number) => {
            ...
            ListItem.width('100%');
            ListItem.opacity(this.animateList[index].alpha);
