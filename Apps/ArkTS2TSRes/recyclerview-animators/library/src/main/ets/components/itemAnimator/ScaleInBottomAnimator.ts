interface ScaleInBottomAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "ScaleInBottomAnimator_" + ++__generate__Id;
}
/*
...
export class ScaleInBottomAnimator extends View {
    ...
    updateWithValueParams(params: ScaleInBottomAnimator_Params) {
