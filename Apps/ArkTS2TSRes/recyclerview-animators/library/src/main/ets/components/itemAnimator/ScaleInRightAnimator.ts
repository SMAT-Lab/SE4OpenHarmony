interface ScaleInRightAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "ScaleInRightAnimator_" + ++__generate__Id;
}
/*
...
export class ScaleInRightAnimator extends View {
    ...
    updateWithValueParams(params: ScaleInRightAnimator_Params) {
