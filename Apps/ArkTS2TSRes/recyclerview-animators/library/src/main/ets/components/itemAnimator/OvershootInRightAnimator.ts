interface OvershootInRightAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "OvershootInRightAnimator_" + ++__generate__Id;
}
/*
...
export class OvershootInRightAnimator extends View {
    ...
    updateWithValueParams(params: OvershootInRightAnimator_Params) {
