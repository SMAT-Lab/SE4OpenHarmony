interface FadeInUpAnimator_Params {
    array?: Array<string>;
...
function generateId(): string {
    return "FadeInUpAnimator_" + ++__generate__Id;
}
/*
...
export class FadeInUpAnimator extends View {
    ...
    updateWithValueParams(params: FadeInUpAnimator_Params) {
