interface DiyCacheHeaderPage_Params {
    ratio?: number;
...
function generateId(): string {
    return "DiyCacheHeaderPage_" + ++__generate__Id;
}
/*
...
import { CacheListener, HeaderInjector, HttpProxyCacheServer, HttpProxyCacheServerBuilder } from '@ohos/video-cache';
import GlobalProxyServer from '../GlobalProxyServer';
import fs from '@ohos.file.fs';
import HashMap from '@ohos.util.HashMap';
const TAG: string = 'MediaDemo HttpPlayer:';
class DiyCacheHeaderPage extends View {
    ...
    updateWithValueParams(params: DiyCacheHeaderPage_Params) {
...
loadDocument(new DiyCacheHeaderPage("1", undefined, {}));
