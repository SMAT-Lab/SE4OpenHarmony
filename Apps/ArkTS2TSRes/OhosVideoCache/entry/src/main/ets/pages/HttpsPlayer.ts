...
function generateId(): string {
    return "HttpsPlayer_" + ++__generate__Id;
}
/*
...
class HttpPlayer extends View {
    ...
    updateWithValueParams(params: HttpPlayer_Params) {
...
loadDocument(new HttpPlayer("1", undefined, {}));
