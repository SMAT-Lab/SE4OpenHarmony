interface RefreshPage_Params {
    isRefreshing?: boolean;
    counter?: number;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "RefreshPage_" + ++__generate__Id;
}
class RefreshPage extends View {
    ...
    updateWithValueParams(params: RefreshPage_Params) {
...
loadDocument(new RefreshPage("1", undefined, {}));
