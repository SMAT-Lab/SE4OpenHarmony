...
export class Decrypt extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__decryptedFileUri = new ObservedPropertySimple('', this, "decryptedFileUri");
    ...
    updateWithValueParams(params: Decrypt_Params) {
        ...
        if (params.decryptedFileUri !== undefined) {
            this.decryptedFileUri = params.decryptedFileUri;
        }
    ...
    aboutToBeDeleted() {
        ...
        this.__decryptedFileUri.aboutToBeDeleted();
    ...
    private __decryptedFileUri: ObservedPropertySimple<string>;
    get decryptedFileUri() {
        return this.__decryptedFileUri.get();
    }
    set decryptedFileUri(newValue: string) {
        this.__decryptedFileUri.set(newValue);
    }
    ...
    render() {
        ...
        Row.width('100%');
        Row.height('48vp');
        Text.create($r('app.string.decrypted_context'));
        Text.fontSize(16);
        Text.textAlign(TextAlign.Start);
        Text.fontWeight(500);
        Text.lineHeight(22);
        ...
        Text.create($r('app.string.decrypt'));
        Text.fontSize(16);
        Text.fontWeight(500);
        Text.lineHeight(22);
