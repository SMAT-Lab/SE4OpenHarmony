...
export class Sign extends View {
    ...
    updateWithValueParams(params: Sign_Params) {
    ...
    render() {
        ...
        Text.create($r('app.string.generate_rsa_key_randomly'));
        Text.fontSize(16);
        Text.fontWeight(500);
        Text.lineHeight(22);
