...
class Index extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__message = new ObservedPropertySimple('js-sha256', this, "message");
    ...
    render() {
        ...
        Button.createWithLabel('sha256');
        Button.width(300);
        Button.margin(20);
        Button.fontSize(25);
        Button.onClick(() => {
            let s1 = sha256(this.inputText);
            this.showDialog(s1);
        });
        Button.pop();
        Button.createWithLabel('sha224');
        Button.width(300);
        Button.margin(20);
        Button.fontSize(25);
        Button.onClick(() => {
            let s1 = sha224(this.inputText);
            this.showDialog(s1);
        });
        Button.pop();
        Column.pop();
