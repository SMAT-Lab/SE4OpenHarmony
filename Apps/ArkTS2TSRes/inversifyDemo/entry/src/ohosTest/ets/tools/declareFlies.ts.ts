...
export function useDecoratorOnMethodThatIsNotAConstructor() {
    __decorate([__param(0, inject('Katana'))], InvalidDecoratorUsageWarrior.prototype as ESObject as NewableFunction, 'test', Object.getOwnPropertyDescriptor(InvalidDecoratorUsageWarrior.prototype, 'test'));
}
