...
export default class RGBLuminanceSource extends LuminanceSource {
    ...
    public constructor(luminances: Uint8ClampedArray | Int32Array, width: number /*int*/, height: number /*int*/, private dataWidth?: number /*int*/, private dataHeight?: number /*int*/, private left?: number /*int*/, private top?: number /*int*/) {
        super(width, height);
