...
export default /*public final*/ class ErrorCorrection {
     ...
     */
    public decode(received: Int32Array, numECCodewords: int, erasures: Int32Array): int {
        ...
        let sigmaOmega: ModulusPoly[] = this.runEuclideanAlgorithm(this.field.buildMonomial(numECCodewords, 1), syndrome, numECCodewords);
    ...
    private findErrorMagnitudes(errorEvaluator: ModulusPoly, errorLocator: ModulusPoly, errorLocations: Int32Array): Int32Array {
