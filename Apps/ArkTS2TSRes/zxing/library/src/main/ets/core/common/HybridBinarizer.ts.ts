...
export default class HybridBinarizer extends GlobalHistogramBinarizer {
     ...
     */
    private static calculateThresholdForBlock(luminances: Uint8ClampedArray, subWidth: number /*int*/, subHeight: number /*int*/, width: number /*int*/, height: number /*int*/, blackPoints: Int32Array[], matrix: BitMatrix): void {
     ...
     */
    private static thresholdBlock(luminances: Uint8ClampedArray, xoffset: number /*int*/, yoffset: number /*int*/, threshold: number /*int*/, stride: number /*int*/, matrix: BitMatrix): void {
     ...
     */
    private static calculateBlackPoints(luminances: Uint8ClampedArray, subWidth: number /*int*/, subHeight: number /*int*/, width: number /*int*/, height: number /*int*/): Int32Array[] {
        const maxYOffset = height - HybridBinarizer.BLOCK_SIZE;
        const maxXOffset = width - HybridBinarizer.BLOCK_SIZE;
