...
export default class AlignmentPatternFinder {
     ...
     */
    public constructor(private image: BitMatrix, private startX: number /*int*/, private startY: number /*int*/, private width: number /*int*/, private height: number /*int*/, private moduleSize: number /*float*/, private resultPointCallback: ResultPointCallback) {
     ...
     */
    private crossCheckVertical(startI: number /*int*/, centerJ: number /*int*/, maxCount: number /*int*/, originalStateCountTotal: number /*int*/): number /*float*/ {
        const image = this.image;
