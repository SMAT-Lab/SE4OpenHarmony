...
export default class Detector {
    ...
    protected processFinderPatternInfo(info: FinderPatternInfo): DetectorResult {
        ...
        const transform: PerspectiveTransform = Detector.createTransform(topLeft, topRight, bottomLeft, alignmentPattern, dimension);
    ...
    private static createTransform(topLeft: ResultPoint, topRight: ResultPoint, bottomLeft: ResultPoint, alignmentPattern: ResultPoint, dimension: number /*int*/): PerspectiveTransform {
    ...
    private static sampleGrid(image: BitMatrix, transform: PerspectiveTransform, dimension: number /*int*/): BitMatrix /*throws NotFoundException*/ {
     ...
     */
    private static computeDimension(topLeft: ResultPoint, topRight: ResultPoint, bottomLeft: ResultPoint, moduleSize: number /*float*/): number /*int*/ /*throws NotFoundException*/ {
     ...
     */
    protected calculateModuleSize(topLeft: ResultPoint, topRight: ResultPoint, bottomLeft: ResultPoint): number /*float*/ {
        // Take the average
     ...
     */
    protected findAlignmentInRegion(overallEstModuleSize: number /*float*/, estAlignmentX: number /*int*/, estAlignmentY: number /*int*/, allowanceFactor: number /*float*/): AlignmentPattern {
