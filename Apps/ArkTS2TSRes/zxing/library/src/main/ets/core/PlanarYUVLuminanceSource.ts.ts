...
export default class PlanarYUVLuminanceSource extends LuminanceSource {
    ...
    public constructor(private yuvData: Uint8ClampedArray, private dataWidth: number /*int*/, private dataHeight: number /*int*/, private left: number /*int*/, private top: number /*int*/, width: number /*int*/, height: number /*int*/, reverseHorizontal: boolean) {
        super(width, height);
