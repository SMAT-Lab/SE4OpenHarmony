...
export default class ITFReader extends OneDReader {
    ...
    */
    public decodeRow(rowNumber: number, row: BitArray, hints?: Map<DecodeHintType, any>): Result {
        ...
        let resultReturn: Result = new Result(resultString, null, // no natural byte representation for these barcodes
     ...
     *!/*/
    private static decodeMiddle(row: BitArray, payloadStart: number, payloadEnd: number, resultString: StringBuilder) {
     ...
     *!/*/
    private static findGuardPattern(row: BitArray, rowOffset: number, pattern: Int32Array): number[] {
