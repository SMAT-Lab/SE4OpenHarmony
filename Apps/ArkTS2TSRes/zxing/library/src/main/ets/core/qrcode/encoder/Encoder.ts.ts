...
export default class Encoder {
    ...
    // }
    public static encode(content: string, ecLevel: ErrorCorrectionLevel, hints: Map<EncodeHintType, any> = null): QRCode /*throws WriterException*/ {
        ...
        const finalBits: BitArray = this.interleaveWithECBytes(headerAndDataBits, version.getTotalCodewords(), numDataBytes, ecBlocks.getNumBlocks());
     ...
     */
    private static recommendVersion(ecLevel: ErrorCorrectionLevel, mode: Mode, headerBits: BitArray, dataBits: BitArray): Version /*throws WriterException*/ {
    ...
    private static calculateBitsNeeded(mode: Mode, headerBits: BitArray, dataBits: BitArray, version: Version): number /*int*/ {
    ...
    private static chooseMaskPattern(bits: BitArray, ecLevel: ErrorCorrectionLevel, version: Version, matrix: ByteMatrix): number /*int*/ /*throws WriterException*/ {
     ...
     * JISX0510:2004 (p.30)
     */
    public static getNumDataBytesAndNumECBytesForBlockID(numTotalBytes: number /*int*/, numDataBytes: number /*int*/, numRSBlocks: number /*int*/, blockID: number /*int*/, numDataBytesInBlock: Int32Array, numECBytesInBlock: Int32Array): void /*throws WriterException*/ {
     ...
     */
    public static interleaveWithECBytes(bits: BitArray, numTotalBytes: number /*int*/, numDataBytes: number /*int*/, numRSBlocks: number /*int*/): BitArray /*throws WriterException*/ {
     ...
     */
    public static appendBytes(content: string, mode: Mode, bits: BitArray, encoding: string): void /*throws WriterException*/ {
        switch (mode) {
            case Mode.NUMERIC:
