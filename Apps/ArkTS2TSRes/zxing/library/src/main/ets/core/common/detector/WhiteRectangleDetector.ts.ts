...
export default class WhiteRectangleDetector {
     ...
     */
    public constructor(private image: BitMatrix, initSize?: number /*int*/, x?: number /*int*/, y?: number /*int*/) {
     ...
     *         leftmost and the third, the rightmost
     */
    private centerEdges(y: ResultPoint, z: ResultPoint, x: ResultPoint, t: ResultPoint): Array<ResultPoint> {
        //
        //       t            t
        //  z                      x
        //        x    OR    z
