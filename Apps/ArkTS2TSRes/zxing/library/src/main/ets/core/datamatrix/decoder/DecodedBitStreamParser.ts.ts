...
export default class DecodedBitStreamParser {
     ...
     */
    private static decodeAsciiSegment(bits: BitSource, result: StringBuilder, resultTrailer: StringBuilder): Mode {
     ...
     */
    private static decodeAnsiX12Segment(bits: BitSource, result: StringBuilder): void {
     ...
     */
    private static decodeBase256Segment(bits: BitSource, result: StringBuilder, byteSegments: Uint8Array[]): void {
     ...
     */
    private static unrandomize255State(randomizedBase256Codeword: number, base256CodewordPosition: number): number {
