...
export default /*final*/ class DecodedBitStreamParser {
    ...
    private static /*final*/ PUNCT_CHARS: string = ';<>@[\\]_`~!\r\t,:\n-.$/"|*()?{}\'';
    private static /*final*/ MIXED_CHARS: string = '0123456789&\r\t,:#-.$/+%*=^';
    /**
        ...
        while (codeIndex < codewords[0]) {
            switch (code) {
                ...
                case DecodedBitStreamParser.ECI_CHARSET:
                    let charsetECI: CharacterSetECI = CharacterSetECI.getCharacterSetECIByValue(codewords[codeIndex++]);
    ...
    static decodeMacroBlock(codewords: Int32Array, codeIndex: int, resultMetadata: PDF417ResultMetadata): int {
        ...
        resultMetadata.setSegmentIndex(Integer.parse(DecodedBitStreamParser.decodeBase900toBase10(segmentIndexArray, DecodedBitStreamParser.NUMBER_OF_SEQUENCE_CODEWORDS)));
                ...
                case DecodedBitStreamParser.BEGIN_MACRO_PDF417_OPTIONAL_FIELD:
                    ...
                    switch (codewords[codeIndex]) {
                        ...
                        case DecodedBitStreamParser.MACRO_PDF417_OPTIONAL_FIELD_SEGMENT_COUNT:
                            ...
                            resultMetadata.setSegmentCount(Integer.parse(segmentCount.toString()));
                            break;
                        ...
                        case DecodedBitStreamParser.MACRO_PDF417_OPTIONAL_FIELD_CHECKSUM:
                            ...
                            resultMetadata.setChecksum(Integer.parse(checksum.toString()));
                            break;
     ...
     * @param result             The decoded data is appended to the result.
     */
    private static decodeTextCompaction(textCompactionData: Int32Array, byteCompactionData: Int32Array, length: int, result: StringBuilder): void {
     ...
     * @return The next index into the codeword array.
     */
    private static /*int*/ byteCompaction(mode: int, codewords: Int32Array, encoding: CharacterSetECI, codeIndex: int, result: StringBuilder) {
