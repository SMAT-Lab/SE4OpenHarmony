...
export default class DecodedBitStreamParser {
    ...
    public static decode(bytes: Uint8Array, version: Version, ecLevel: ErrorCorrectionLevel, hints: Map<DecodeHintType, any>): DecoderResult /*throws FormatException*/ {
     ...
     */
    private static decodeHanziSegment(bits: BitSource, result: StringBuilder, count: number /*int*/): void /*throws FormatException*/ {
    ...
    private static decodeKanjiSegment(bits: BitSource, result: StringBuilder, count: number /*int*/): void /*throws FormatException*/ {
        // Don't crash trying to read more bits than we have available.
        if (count * 13 > bits.available()) {
            throw new FormatException();
        }
    ...
    private static decodeByteSegment(bits: BitSource, result: StringBuilder, count: number /*int*/, currentCharacterSetECI: CharacterSetECI, byteSegments: Uint8Array[], hints: Map<DecodeHintType, any>): void /*throws FormatException*/ {
        // Don't crash trying to read more bits than we have available.
    ...
    private static decodeAlphanumericSegment(bits: BitSource, result: StringBuilder, count: number /*int*/, fc1InEffect: boolean): void /*throws FormatException*/ {
    ...
    private static decodeNumericSegment(bits: BitSource, result: StringBuilder, count: number /*int*/): void /*throws FormatException*/ {
