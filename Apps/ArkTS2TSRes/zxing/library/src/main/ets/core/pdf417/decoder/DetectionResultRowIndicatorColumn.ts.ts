...
export default /*final*/ class DetectionResultRowIndicatorColumn extends DetectionResultColumn {
    ...
    getBarcodeMetadata(): BarcodeMetadata {
        ...
        let barcodeMetadata: BarcodeMetadata = new BarcodeMetadata(barcodeColumnCount.getValue()[0], barcodeRowCountUpperPart.getValue()[0], barcodeRowCountLowerPart.getValue()[0], barcodeECLevel.getValue()[0]);
        this.removeIncorrectCodewords(codewords, barcodeMetadata);
