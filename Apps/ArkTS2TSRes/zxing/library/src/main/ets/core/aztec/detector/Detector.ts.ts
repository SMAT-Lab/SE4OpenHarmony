...
export default class Detector {
    ...
    public detectMirror(isMirror: boolean): AztecDetectorResult {
        ...
        // 4. Sample the grid
        let bits: BitMatrix = this.sampleGrid(this.image, bullsEyeCorners[this.shift % 4], bullsEyeCorners[(this.shift + 1) % 4], bullsEyeCorners[(this.shift + 2) % 4], bullsEyeCorners[(this.shift + 3) % 4]);
