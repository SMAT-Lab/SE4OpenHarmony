...
export default class MatrixUtil {
    ...
    public static buildMatrix(dataBits: BitArray, ecLevel: ErrorCorrectionLevel, version: Version, maskPattern: number /*int*/, matrix: ByteMatrix): void /*throws WriterException*/ {
    ...
    private static embedHorizontalSeparationPattern(xStart: number /*int*/, yStart: number /*int*/, matrix: ByteMatrix): void /*throws WriterException*/ {
        for (let x = 0; x < 8; ++x) {
    ...
    private static embedVerticalSeparationPattern(xStart: number /*int*/, yStart: number /*int*/, matrix: ByteMatrix): void /*throws WriterException*/ {
        for (let y = 0; y < 7; ++y) {
