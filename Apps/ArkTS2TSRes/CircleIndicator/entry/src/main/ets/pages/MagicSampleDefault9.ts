interface MagicSampleDefault_Params {
    ...
    model9?: MagicScrollTabsModel;
    index?: number;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "MagicSampleDefault9_" + ++__generate__Id;
}
/*
...
class MagicSampleDefault extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__model9 = new ObservedPropertyObject(new MagicScrollTabsModel(this.controller), this, "model9");
    ...
    updateWithValueParams(params: MagicSampleDefault_Params) {
        ...
        if (params.model9 !== undefined) {
            this.model9 = params.model9;
        }
    ...
    aboutToBeDeleted() {
        this.__model9.aboutToBeDeleted();
        this.__index.aboutToBeDeleted();
        SubscriberManager.Get().delete(this.id());
    }
    private initData: Array<string>;
    private controller: TabsController;
    private __model9: ObservedPropertyObject<MagicScrollTabsModel>;
    get model9() {
        return this.__model9.get();
    }
    set model9(newValue: MagicScrollTabsModel) {
        this.__model9.set(newValue);
    }
    ...
    aboutToAppear() {
        this.model9
            ...
            .setScrollPivotX(0.15)
            .setCursorType(MagicCursorType.TRIANGLE)
            .setStrokeWidth(3)
            .setTriangleHeight(8)
            .setTriangleWidth(14);
    }
    render() {
        ...
        __Tabs__indicator((event: TouchEvent) => {
            ...
            this.model9.notifyTouch(event, index);
        });
