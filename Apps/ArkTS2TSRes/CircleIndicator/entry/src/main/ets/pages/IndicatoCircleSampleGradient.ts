interface IndicatoCircleSampleGradient_Params {
    text?;
...
function generateId(): string {
    return "IndicatoCircleSampleGradient_" + ++__generate__Id;
}
/*
...
class IndicatoCircleSampleGradient extends View {
    ...
    updateWithValueParams(params: IndicatoCircleSampleGradient_Params) {
...
loadDocument(new IndicatoCircleSampleGradient("1", undefined, {}));
