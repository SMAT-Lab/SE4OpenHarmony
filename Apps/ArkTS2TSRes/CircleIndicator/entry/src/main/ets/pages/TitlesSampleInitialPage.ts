interface TitlesSampleInitialPage_Params {
...
function generateId(): string {
    return "TitlesSampleInitialPage_" + ++__generate__Id;
}
/*
...
class TitlesSampleInitialPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__index = new ObservedPropertySimple(3, this, "index");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: TitlesSampleInitialPage_Params) {
    ...
    aboutToAppear() {
        this.model.setBackgroundColor(0xffcccccc);
    }
    calcText(text: string): string {
        return (text + " ").repeat(20);
    }
}
loadDocument(new TitlesSampleInitialPage("1", undefined, {}));
