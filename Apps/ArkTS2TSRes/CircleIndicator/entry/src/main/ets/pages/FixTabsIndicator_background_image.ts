...
function generateId(): string {
    return "FixTabsIndicator_background_image_" + ++__generate__Id;
}
/*
...
class FixTabsIndicator_page extends View {
    ...
    aboutToAppear() {
        this.model
            .setCursorType(FixCursorType.Block)
            .setCursorColor('#878787')
            .setCursorRadius(10)
            .setCursorImage($r("app.media.slide"))
            .setCursorText('Yeah!')
            .setBgHeightPercent("75%")
