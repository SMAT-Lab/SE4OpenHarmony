interface TitlesSampleDefault_Params {
...
function generateId(): string {
    return "TitlesSampleDefault_" + ++__generate__Id;
}
/*
...
class TitlesSampleDefault extends View {
    ...
    updateWithValueParams(params: TitlesSampleDefault_Params) {
...
loadDocument(new TitlesSampleDefault("1", undefined, {}));
