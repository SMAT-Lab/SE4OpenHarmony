interface BannerSampleDefault_Params {
...
function generateId(): string {
    return "BannerSampleStyled_" + ++__generate__Id;
}
/*
...
class BannerSampleDefault extends View {
    ...
    updateWithValueParams(params: BannerSampleDefault_Params) {
    ...
    aboutToAppear() {
        this.model.setColor(0xFFCC0000)
            .setBackgroundColor("#FFCCCCCC")
            .setFadeDelay(1000)
            .setFadeLength(1000)
            .setHeight(4);
    }
}
loadDocument(new BannerSampleDefault("1", undefined, {}));
