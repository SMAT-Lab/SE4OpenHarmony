interface TitlesSampleTriangle_Params {
...
function generateId(): string {
    return "TitlesSampleTriangle_" + ++__generate__Id;
}
/*
...
class TitlesSampleTriangle extends View {
    ...
    updateWithValueParams(params: TitlesSampleTriangle_Params) {
    ...
    aboutToAppear() {
        this.model
            ...
            .setFooterIndicatorStyle(TitleIndicatorStyle.TRIANGLE);
    }
    calcText(text: string): string {
        return (text + " ").repeat(20);
    }
}
loadDocument(new TitlesSampleTriangle("1", undefined, {}));
