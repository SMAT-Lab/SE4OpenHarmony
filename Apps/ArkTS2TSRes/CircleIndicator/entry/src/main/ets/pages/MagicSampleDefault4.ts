interface MagicSampleDefault4_Params {
    initData?: Array<string>;
    controller?: TabsController;
    model4?: MagicScrollTabsModel;
    index?: number;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "MagicSampleDefault4_" + ++__generate__Id;
}
/*
...
class MagicSampleDefault4 extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.__model4 = new ObservedPropertyObject(new MagicScrollTabsModel(this.controller), this, "model4");
        this.__index = new ObservedPropertySimple(0, this, "index");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: MagicSampleDefault4_Params) {
    ...
    aboutToBeDeleted() {
        this.__model4.aboutToBeDeleted();
        this.__index.aboutToBeDeleted();
        SubscriberManager.Get().delete(this.id());
    }
    private initData: Array<string>;
    private controller: TabsController;
    private __model4: ObservedPropertyObject<MagicScrollTabsModel>;
    get model4() {
        return this.__model4.get();
    }
    set model4(newValue: MagicScrollTabsModel) {
        this.__model4.set(newValue);
    }
    ...
    render() {
        ...
        __Tabs__indicator((event: TouchEvent) => {
            ...
            this.model4.notifyTouch(event, index);
        });
...
loadDocument(new MagicSampleDefault4("1", undefined, {}));
