...
export class provideDoneSyntaxInterface {
    ...
    public static binding: interfaces.BindConstraint = (bind: inversifyInterfaces.Bind, target: any) => (<any>provideDoneSyntaxInterface.bindingInSyntax(bind, target))._binding;
