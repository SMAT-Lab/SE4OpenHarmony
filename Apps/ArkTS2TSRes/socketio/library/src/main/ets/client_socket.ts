...
function generateId(): string {
    return "client_socket_" + ++__generate__Id;
}
/**
 ...
 */
var client_socket_c = globalThis.requireNapi("client_socket_c", true);
;
...
export class client_socket {
    ...
    public emit(name: string, message: any, on_emit_callback?: (emit_callback_json: string) => void) {
