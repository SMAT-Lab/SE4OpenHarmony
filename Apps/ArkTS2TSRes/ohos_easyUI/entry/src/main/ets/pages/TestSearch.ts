...
function generateId(): string {
    return "TestSearch_" + ++__generate__Id;
}
/*
 ...
 */
import { search_advance, search_default, search_listen } from 'easyui';
