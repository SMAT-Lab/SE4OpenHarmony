interface TestImageCrop_Params {
    Img?: ImageItem;
}
let __generate__Id: number = 0;
function generateId(): string {
    return "TestImageCrop_" + ++__generate__Id;
}
/*
...
import { ImageCrop } from "easyui";
class TestImageCrop extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        super(compilerAssignedUniqueChildId, parent, localStorage);
        this.__Img = AppStorage.SetAndLink("Img", new ImageItem(""), this, "Img");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params: TestImageCrop_Params) {
    }
    aboutToBeDeleted() {
...
loadDocument(new TestImageCrop("1", undefined, {}));
