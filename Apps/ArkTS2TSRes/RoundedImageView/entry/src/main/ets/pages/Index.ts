...
class Index extends View {
    constructor(compilerAssignedUniqueChildId, parent, params, localStorage) {
        ...
        this.uiWidth = px2vp((GlobalContext.getContext().getObject("deviceW") as number) * 0.95);
        this.uiHeight = px2vp(500);
        this.uriFolder = (GlobalContext.getContext().getObject("globalFilesDir") as string) + "/" + "uriFolder";
    ...
    private initUri() {
        ...
        (GlobalContext.getContext().getObject("context") as Context).resourceManager.getMedia($r('app.media.photo1').id, (error: Error, value: Uint8Array) => {
    ...
    render() {
        ...
        Button.createWithLabel('测试HSP场景');
